...
<body>
	<div id="datagrid_revise_history" dataField="reviseRecords" 
		...
		<div property="columns">
            ...
            <div field="cIsValid" headerAlign="center" align="center" width="90px" renderer="renderInstructStatus">
               指令/建议状态
            </div>
            ...
            <div field="vcEntrustDirection" headerAlign="center" width="85px" renderer="renderEntrustDirection">
          	...
          	<div field="vcCounterpartyName" headerAlign="center" width="100px">
	交易对手
			</div>
            ...
            <div field="lIssueDate" headerAlign="center" width="120px">
                录入日期
            </div>
