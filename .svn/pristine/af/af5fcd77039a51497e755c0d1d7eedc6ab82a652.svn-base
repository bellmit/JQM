  ...
  <div class="search-condition">
		...
		<form id="form_ZYSHGLB" method="post" >
			...
			<table id="table1" class="table" style="height:100%;table-layout:fixed;">
				<tr>
					...
					<td >
						<input id="vcRevreposts_MDSHGLB" class="nui-textbox"  name="paramObject/vcRevreposts" style="width:80%"/>
					</td>
					...
					<td >
						<input id="vcRevreponm_MDSHGLB" class="nui-textbox" name="paramObject/vcRevreponm" style="width:80%"/>
					</td>
					<td    width="80px" align="right">
						交易状态:
					</td>
					<td >
						<input id="vcTradests_MDSHGLB" class="nui-textbox" name="paramObject/vcTradests" style="width:80%"/>
					</td>
				</tr>
				<tr>
					<td    align="right">
					...
					<td >
						<input id="vcSellreposts_MDSHGLB" class="nui-textbox" name="paramObject/vcSellreposts" style="width:80%"/>
					</td>
					<td  align="right">
						正回购方持有人简称:
					</td>
					<td >
						<input id="vcSellreponm_MDSHGLB" class="nui-textbox"  name="paramObject/vcSellreponm" style="width:80%"/>
					</td>
					<td align="right">
							数据日期:
					</td>
				...
				<tr>
					...
					<td >
						<input id="vcTxdt_MDSHGLB" class="nui-datepicker" allowInput="false"  name="paramObject/vcTxdt" style="width:80%"/>
					</td>
					<td align="right">
						首期结算日期:
					</td>
					<td >
						<input id="vcFrststtlmdt_MDSHGLB" class="nui-datepicker" allowInput="false"  name="paramObject/vcFrststtlmdt" style="width:80%"/>
					</td>
					<td  align="right">
						到期结算日期:
					</td>
					<td >
						<input id="vcScndsttlmdt_MDSHGLB" class="nui-datepicker" allowInput="false" name="paramObject/vcScndsttlmdt" style="width:80%"/>
					</td>
				</tr>
			</table>
		</form>
	...
	<div class="nui-fit">
		...
		<div property="columns">
			...
			<div field="VC_SELLREPOSTSREM" headerAlign="center" allowSort="true" align="right" width="105px">
					正回购方状态备注
			</div>
			<div field="VC_REVREPOSTS" headerAlign="center" allowSort="true" align="right">
					逆回购方状态
			</div>
			<div field="VC_REVREPOSTSREM" headerAlign="center" allowSort="true" align="right" width="105px">
					逆回购方状态备注
			</div>
...
<script type="text/javascript">
	...
	//全屏显示
	function fullScreen(){
		window.open('<%=request.getContextPath()%>/sm/comm/back_stage_trader/bst_zyshglb_detail.jsp','newwindow','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
	}
	//刷新
	//“今日待处理”模块自动刷新功能处理
