...
<div style="margin-bottom: 5px;">
        <div class="inputContainer" id="fullDirection">
            ...
            <ul>
                ...
                <li liType='input'><label><span>*</span>回购天数:</label>
                    <div>
                        <input class="nui-spinner" id="lRepoDays" required="true" name="lRepoDays"
                               onblur="caclSymbol(true,'5','1')" maxValue="365" onvalidation="lRepoDaysNum"
                               style="width: 100%;"/>
                    </div>
                </li>
                ...
                <li liType='input'><label><span>*</span>回购金额(万元):</label>
                    <div><input class="nui-spinner" minValue="0" maxValue="999999999999" format="n4"
                                id="enFaceAmount"
                                name="enFaceAmount"
                                required="true"
                                vtype="float"
                ...
                <li liType='input'><label><span>*</span>报价方式:</label>
                    <div>
                ...
                <li liType='input'><label>对手主体机构:</label>
                    <div><input class="nui-textbox" showClose="true" id="vcCounterpartyOrgan"
                                name="vcCounterpartyOrgan"  onvalidation="organVali" style="width: 100%;"/></div>
                </li>
                <li liType='input'>
                    ...
                    <input name="enWeightingValue" style="display:none;" id="enWeightingValue"
                                class="nui-textbox" showClose="true"  required="true"
                                oncloseclick="onCloseClick" onvalidation="weightValueVali" 
                ...
                <li liType='input'><label>备注:</label>
                    <div><input class="nui-textbox" showClose="true" id="vcRemark" onvalidation="remarkVali" name="vcRemark" style="width: 100%;"/></div>
                </li>
                ...
                <li liType='input'><label>询价交易员:</label>
                    <div><input class="nui-textbox" id="lInquiryTrader" name="lInquiryTrader" style="width: 100%;"/></div>
                </li>
                <li liType='input'><label>实际对手方:</label>
                    <div><input class="nui-textbox" id="lActuallyCounterParty" name="lActuallyCounterParty" style="width: 100%;"/></div>
                </li>
                 <li liType='input'><label>中介:</label>
                    <div><input class="nui-textbox" id="lIntermediaryAgent" name="lIntermediaryAgent" style="width: 100%;"/></div>
                </li>
                 <li liType='input'><label>对手方类型:</label>
                    <div><input class="nui-dictcombobox" id="lCounterPartyType"  name="lCounterPartyType" valueField="dictID" textField="dictName" dictTypeId="l_counter_party_type" showNullItem="true" style="width: 100%;"/></div>
                </li>
            </ul>
        </div>
    <div style="height:auto;width:100%;">
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:80%;" align="left">
                        ...
                        <a class="nui-button" id="showHoldingButton"  enabled="false"  onclick="showHolding()" plain="true" iconCls="icon-search">从持仓选择</a>
                    </td>
                </tr>
            </table>
        </div>
        <div id="bondsGrid" class="nui-datagrid" style="width:100%;height:170px;"
            ...
            <div property="columns">
                ...
                <div field="vcReportCode" align="left" headerAlign="center"> 债券代码</div>
                <div field="vcStockName" headerAlign="center" align="left" width="100" >债券名称</div>
                
                <div field="enFaceAmount" width="100" numberFormat="n2" renderer="onGenderRenderer" align="right"
                     headerAlign="center">
                ...
                <div field="enMortagageRatio" align="left" width="100" headerAlign="center"><span style="color:red;">*</span>质押比例（%）
                    <input property="editor" floatErrorText="true" onblur="updateMortagage(e)"   onenter="updateMortagage(e)" class="mini-textbox"
                           style="width:100%;"/>
                </div>
                <div field="canRepurchaseAmount" headerAlign="center"  align="right" numberFormat="n4" width="100">
                    可做回购金额(万元)
                </div>
                <div field="enCbValueNetValue"  align="right" headerAlign="center" width="100" allowSort="false" format="n4">
                    净价（T-1）
                </div>
                <div field="enCbValueAllValue"  align="right" headerAlign="center" width="100" format="n4">全价(T-1)</div>
    ...
    <div style="text-align: center;padding-top: 10px;">
        <span style="display: block;width:auto;float:left;color:#FF404B;" id="MaxRepurchAmount">可做回购金额:</span>
		<div style="text-align: center;float:left;width:95%;position: fixed;padding-right: 20px;">
    		...
    		<a class="nui-button" plain="true" iconCls="icon-save" onclick="saveDirective()">保存</a>
...
<script type="text/javascript">
    ...
    function initWin(tabIndex,data){
		...
		nui.getbyName("lProductId").setValue(data["lProductId"]); //产品名称
    	fundCodeData[data.vcProductCode] = {
    		L_PRODUCT_ID:data.lProductId
    	};
    	nui.get("showHoldingButton").enable();
    	nui.get("vcProductCode").setEnabled(false);
    	if(data["vcEntrustDirection"]=="5"){
	    	$("#vcEntrustDirectionLab:not(span)").css({"color":"red"});
	    	vcStockCodeAuto.url = "com.cjhxfund.ats.sm.comm.TBondBaseInfoManager.getFundBond.biz.ext?fundId="+data.vcProductCode;
	    }else if(data["vcEntrustDirection"]=="6"){
    ...
    function showHolding() {
        nui.open({
            url: "<%=request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/holding/collateraliseHolding.jsp",
            title: "银行间债券持仓",
            width: 850,
            height: 520,
            allowResize: true,
...
<script type="text/javascript" src="<%=request.getContextPath()%>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/js/repurchaseComm.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/riskMgr/js/riskMgrComm.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/js/collateraliseRepo.js"></script>
</body>
</html>