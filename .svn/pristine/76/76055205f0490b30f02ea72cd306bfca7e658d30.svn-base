...
<div class="nui-fit" style="padding:10px;">
		...
		<div class="nui-toolbar" style="text-align:left;line-height:30px;padding:5px 0px 5px 10px;" borderStyle="border-bottom:0;">
			<table id="employeeToolBar">
				<tr>
					...
					<td style="width:70px; text-align:right;"><input class='nui-button' plain='false' iconCls="icon-search" text="查询" onclick="searchEmployee" /></td>
	...
	<div class="nui-fit">
		<div id="employeeGrid" class="nui-datagrid" style="width:100%;height:100%;"  onload="onGridLoad"
			...
			idField="empid" allowResize="false" allowCellEdit="true" sizeList="[10,20,50,100,500]" pageSize="500" multiSelect="true">
		    <div property="columns">
		        ...
		        <div field="orgname" width="150" headerAlign="center" allowSort="true">所属机构</div>
		        <div type="checkboxcolumn" field="auth" width="80" trueValue="1" falseValue="">授权</div>
		    </div>
		</div>
	</div>
</div>
