...
<body>
	...
	<div class="search-condition">
		<div class="list">
			<div id="task_condition" class="nui-form" style="padding:2px;height:10%;" align="left">
		        ...
		        <td align="left">
							<input name="task/vcCombiNo" class="nui-combobox" id="vcCombi"
							textField="TEXT" valueField="ID"
							dataField="data"
	...
	<div class="nui-fit">
		...
		url="com.cjhxfund.commonUtil.taskManager.queryWorkItem.biz.ext" 
	...
	function viewFlowChart(){
		window.open(nui.context+"/com.cjhxfund.foundation.task.ProcessChart.flow?processInstID="+grid.getSelected().lProcessinstId);
	}
