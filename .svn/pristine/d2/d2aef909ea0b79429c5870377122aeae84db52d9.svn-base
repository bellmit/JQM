		...
		<div region="center" style="width:100%; height:570px">
			...
			<l:equal property="cBizType" propertyType="parameter" targetValue="1"  >
			   ...
			   <l:equal property="biztypename" propertyType="parameter" targetValue="缴款流程"  >
			    ...
			    <l:equal property="biztypename" propertyType="parameter" targetValue="转债申购"  >
				<!-- 转债申购信息 -->
   				<%-- <%@include file="/riskMgr/instruct/firstGradeDabtZzsgView.jsp" %> --%>
			    </l:equal>
			...
			<!-- 审批意见 -->
			<%-- <%@include file="/bpsExpend/processComm/processControlInBiz.jsp?processInstID=processInstID&workItemID="+workItemID %> --%>
