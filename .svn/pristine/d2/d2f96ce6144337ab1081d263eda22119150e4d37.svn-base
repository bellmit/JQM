...
public class VerifyCodeServlet extends HttpServlet {     
    ...
    */  
    ...
    //记录用户登录信息
    public static Map<String,UserText> userMap = new HashMap<String, UserText>();
    ...
    */  
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException {     
        ...
        for (int i = 0; i < codeCount; i++) {     
            ...
            red = setColor(random.nextInt(255)); 
            green = setColor(random.nextInt(255));     
            blue = setColor(random.nextInt(255));  
        ...
        validateMap.put("validateCode", randomCode.toString());
        // 禁止图像缓存。     
  ...
  //获取验证码
    ...
    public String getValidateCode(){
    	//获取验证码
    	String validate = validateMap.get("validateCode");
    	//清空对象
    	validateMap.remove("validateMap");
    	return validate;
    }
