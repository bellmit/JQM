	...
	<div class="nui-fit" style="padding:10px;">
		...
		<div class="nui-fit">
			<div id="orgGrid" class="nui-datagrid" style="width:100%;height:100%;" onload="onGridLoad"
				...
				dataField="data" idField="groupid" allowResize="false" sizeList="[10,20,50,100,500]" pageSize="20" multiSelect="true" allowCellEdit="true">
			    <div property="columns">
			    	<div type="indexcolumn" width="30px"></div>
			        <div field="groupid" width="120" headerAlign="center" >工作组编号</div>
			        <div field="groupname" width="150" headerAlign="center" >工作组名称</div>
