...
<head>
<title>参与者选择</title>
<link id="common-style" rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/coframe/tools/skins/skin1/css/style.css"/>
<link id="common-style" rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/scripts/com.cjhxfund.js.common/common-style.css"/>
...
<div class="mini-splitter" style="width:100%;height:100%;">  
    <div size="30%" showCollapseButton="true"> <!-- com.cjhxfund.fpm.util.organization.findAllorganization.biz.ext -->
    ...
    <div showCollapseButton="true">
    	<div id="form1" class="nui-form" align="center" style="height:100%;height:10%;">
            <!-- 数据实体的名称 -->
            <!-- 排序字段 -->
            <table id="table1" class="table" style="height:100%; width: 100%;">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="targetName" id="targetName"/>
                    </td>
                    <td colspan="1">
         ...
         <div class="nui-fit" style="width:100%;height:85%;">
            <div 
                ...
                url="com.cjhxfund.ats.fm.comm.common.deptUserList.biz.ext"
