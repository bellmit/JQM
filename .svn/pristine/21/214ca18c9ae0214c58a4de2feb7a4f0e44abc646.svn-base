...
public class ProductUtil {
	...
	/** 上传文件保存路径-招行附件 */
	public static final String UPLOAD_FILE_PATH_ZH = "/home/ats/FileUploadPath/fm/ZhaoHang";
	
	/** 上传文件保存路径-利率互换开仓附件 */
	public static final String UPLOAD_FILE_PATH_INTERESTSWAP = "/home/ats/FileUploadPath/fm/openinterest";
	
	/** 上传文件保存路径-利率互换冲销平仓附件 */
	public static final String UPLOAD_FILE_PATH_CHARGEAGAINST = "/home/ats/FileUploadPath/fm/chargeagainst";
	
	/** 上传文件保存路径-出入金附件 */
	public static final String UPLOAD_FILE_PATH_GOLD = "/home/ats/FileUploadPath/fm/gold";
	
	/** 上传文件保存路径-其他附件 */
	public static final String UPLOAD_FILE_PATH_TEMP = "/home/ats/FileUploadPath/fm/temp";
