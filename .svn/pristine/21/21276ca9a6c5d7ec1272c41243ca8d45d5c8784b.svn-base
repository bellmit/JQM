        ...
        <div id="dataform1" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                ...
                <tr>
                    ...
                    <td colspan="1" width="27%">
                      <input class="nui-combobox" style="width:150px;" id="vcCombiNo" style="width:150px;"  required="true" dataField="productCombis"  name="cfjyproductprocess.vcCombiNo" 
                   ...
                   <td align="right" width="23%">
                    ...
                    <td colspan="1" width="27%">
                        <input id="investProductCode" style="width:150px;" class="nui-autocomplete" popupWidth="300" popupHeight="200" name="cfjyproductprocess.investProductCode" searchField="searchKey" dataField="investProducts"
                        	...
                        	onvaluechanged="enterSumbit" onitemclick="investProductCodeOnItemClick" required="true"/>
                    </td>
                    <td align="right" width="23%">
                        证券名称:
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="tpZcya" class="nui-textarea" name="cfjyproductprocess.tpZcya" width="95%" height="100px" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td colspan="3">
                        <input id="tpFdyz" class="nui-textarea" name="cfjyproductprocess.tpFdyz" width="95%" height="100px" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td colspan="3">
                        <input id="tpQqya" class="nui-textarea" name="cfjyproductprocess.tpQqya" width="95%" height="100px" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
