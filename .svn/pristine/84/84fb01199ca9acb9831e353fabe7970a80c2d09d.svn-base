...
<body>
	...
	<div  class="nui-fit">
		...
		<div property="columns" >
			...
			<div field="lCurrentAmount" headerAlign="center" align="right" width="85px" allowSort="true" numberFormat="#,0" >
				持仓数量
			</div>
    ...
    <script type="text/javascript" src="<%= request.getContextPath() %>/transaction/investNew/HoldingPages/js/interbankHolding.js"></script>
