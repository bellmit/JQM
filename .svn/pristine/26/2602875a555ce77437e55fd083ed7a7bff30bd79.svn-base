...
<div id="vunitstockGrid" dataField="vunitstockList"
     url="com.cjhxfund.ats.sm.repurchase.RepurchaseBizManager.QuerySSVunitstock.biz.ext"
    ...
    <div property="columns">
        ...
        <div field="lCurrentAmount" width="100" headerAlign="center" numberFormat="#,0">持仓数量</div>
        <div field="vcAvailablequantityT0" width="100" numberFormat="#,0">T+0可质押数量</div>
        <div field="vcAvailablequantityT1" width="100" numberFormat="#,0">T+1可质押数量</div>
        <div field="vcMortagageQty" width="100" numberFormat="#,0">在途质押数量</div>
        <div field="lLockQty" width="100" numberFormat="#,0" renderer="lLockQtyRD">锁定数量</div>
        <div field="lMortagageAmount" width="120" headerAlign="center">当日回转数</div>
    ...
    <div style="width:540px;float:right;margin-top:5px;padding-right: 0;">
        <div class="nui-tabs" style="width:538px;height:auto;" activeIndex="0">
            <div title="完整指令/建议">
                    ...
                    <div>
                       ...
                       <div class="infoLabel"><label> <span>*</span>产品名称: </label>
                        ...
                        <div class="infoLabel">
                            ...
                            data-options='{dateType:"01"}' onvaluechanged="calFirstMaturityRe()" class="nui-datepicker" 
                        ...
                        <div class="infoLabel"><label><span>*</span>回购天数:</label>
                            <input class="nui-spinner" id="lRepoDays" required="true" name="lRepoDays"
                                   onblur="caclSymbol(true,'1','1')" maxValue="365" onvalidation="positiveNum"/>
                        </div>
                         <div class="infoLabel"><label> 到期结算日期:</label>
                            <input class="nui-datepicker" id="lMaturitySettleDate" allowInput="false" 
                             data-options='{dateType:"01"}'
                                   ...
                                   onvalidation="setlMaturitySettleDate"/>
                        </div>
                        <div class="infoLabel" id="changeInfoL" style="color:red;">
                            ...
                            <input class="nui-radiobuttonlist" name="vcEntrustDirection" id="vcEntrustDirection"
                                   data="[{id: '15', text:'正回购'}, {id: '16', text: '逆回购'}]" required="true"
                                   onvaluechanged="changeRed(this.value)" value="15"/>
                        </div>
                       <div class="infoLabel"><label> 到期结算金额(元):</label>
                            <input  id="enSettleAmount" vtype="float" name="enSettleAmount"
                                   class="nui-spinner" minValue="0" maxValue="100000000000000000000" 
                        ...
                        <div class="infoLabel"><label><span>*</span>清算速度: </label>
                            <input class="nui-radiobuttonlist" name="vcSettleSpeed" id="vcSettleSpeed"
                                   data="[{id: '0', text:'T+0'}]" required="true"
                        ...
                        <div class="infoLabel"><label> <span>*</span>回购金额(万元):</label>
                            <input class="nui-spinner" minValue="0" maxValue="999999999999" format="n6"
                                   id="enFaceAmount"
                                   name="enFaceAmount"
                                   required="true"
                                   vtype="float"
                        ...
                        <div class="infoLabel"><label> 回购利息(元):</label>
                            <input class="nui-spinner" minValue="0" maxValue="100000000000000000000" 
                             enabled="false" id="enRepoInterest" name="enRepoInterest"
                                   vtype="float"  format="n2"/>
                        </div>
                        ...
                        <div class="infoLabel"><label> <span>*</span> 对方交易员:</label>
                            <input class="nui-textbox" id="vcCounterpartyTrader" name="vcCounterpartyTrader" required="true" />
                        </div>
                        ...
                        <div class="infoLabel">
                            ...
                            <input name="enRepoRate" id="enRepoRate" class="nui-spinner" showClose="true"
                                   oncloseclick="onCloseClick" onvalidation="positiveFloProtocol" minValue="0" maxValue="1000000000"required="true"
                                   onblur="calEmFaceAmount()"/>
    ...
    <div style="float:left;width:100%;">
        ...
        <div id="bondsGrid" class="nui-datagrid" style="width:100%;height:225px;"
            ...
            <div property="columns">
                ...
                <div field="enMortagageRatio" align="center" width="100"><span style="color:red;">*</span>质押比例（%）
...
<script type="text/javascript" src="<%=contextPath%>/repurchase/invest/protocol_repo/js/initialInstruct.js"></script>
