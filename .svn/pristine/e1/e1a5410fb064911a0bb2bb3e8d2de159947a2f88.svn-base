...
<body>
	...
	<script type="text/javascript">
		...
		combination_distribution_tab.url = idataUrl+"&resid=I8a49602f0af779fb0158a893acf64ca1";
		...
		function activeChangeTabs(){
			...
			if(activeTabTitle.indexOf("产品触及风控指标统计")!=-1){
				...
				combination_limit_tab.url = idataUrl+"&resid=I8a49602f0af779fb0158a8b37143505f";
			}
			//风险资产
			if(activeTabTitle.indexOf("风险资产")!=-1){
				var combination_credit_tab = nui.get("noldingsDetailTabs").getTab("combination_credit_tab");
				combination_credit_tab.url = idataUrl+"&resid=I8a49602f0af779fb0158a8b651525142";
			}
    	}
    </script>
</body>
