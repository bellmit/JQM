	 ...
	 <table style="height:99%;">
	   <tr>
	    <td style="width:120px;height:100%;">
	    	<div id="listbox1" class="nui-listbox" style="width:350px;height:100%;"
	            textField="name" valueField="id" ajaxData="getAjaxData" multiSelect="true"
	         	...
	         	<div property="columns">
	               ...
	               <div header="已授予角色" field="name" renderer="renderAuthorizedRoleList" width="230px"></div>
	            </div>
	        </div>
	    </td>
	    <td style="width:120px;height:100%;text-align:center;">
	        <input class='nui-button' plain='false' text="取消" onclick="remove()" style="width:65px;margin-top:5px;"/><br />
	        <input class='nui-button' plain='false' text="全部取消" onclick="removeAll()" style="width:65px;margin-top:5px;"/><br />
	        <input class='nui-button' plain='false' text="全部授权" onclick="addAll()" style="width:65px;margin-top:5px;"/><br />
	        <input class='nui-button' plain='false' text="授权" onclick="add()" style="width:65px;margin-top:5px;"/><br />
	    </td>
	    <td style="width:120px;height:100%;">
		   <div id="listbox2" class="nui-listbox" style="width:350px;height:100%;"
			    textField="name" valueField="id" showCheckBox="true" ajaxData="getAjaxData" multiSelect="true"
			   dataField="unauthorizedRoleList">
				 <div property="columns">
				 	  <div type="indexcolumn" width="20px"></div>
				      <div header="未授予角色" field="name" width="230px"></div>
				 </div>
			</div>
	    </td>
	    </tr>
...
<div id="toolBar" class="nui-toolbar" style="text-align:center;padding-top:5px;padding-bottom:5px;visibility:hidden;" 
    ...
    <a class='nui-button' plain='false' id="cancelBtn_01" iconCls="icon-cancel" style="width:60px;" onclick="cancel">关闭</a>
</div>
