...
<body onload="updateTab()">
	<div class="nui-tabs" activeIndex="0" id="tab" style="width:100%;height:100%;">
		<div title="正逆回购" url="<%= request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultConfirm/repurchase/inquiryResultInstruct.jsp"></div>
		<div title="债券买卖" url="<%= request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultConfirm/transaction/inquiryResultInstruct.jsp"></div>
	</div> 	
	<script type="text/javascript">
	    ...
	    function updateTab(){
	    	//今日待处理”模块数据
	        var json = {processDate: dateStr,webType:1};		// webType: 1-投资经理确认页面，2-交易员页面
	        nui.ajax({
