		...
		<table id="zqmm" style="width: 100%; table-layout: fixed; display: none;" class="nui-form-table">
			...
			<tr>
                ...
                <td colspan="3" width="49%">    
                    <input name="resultInstruct.vcRemark" class="nui-textarea" style="width:100%;" readonly/>
                </td>
                <td class="form_label td1" width="17%" align="right"></td>
				<td colspan="1" width="16%">
				</td>
		...
		success : function(text) {
			...
			if(returnJson.exception == null){
				if(returnJson.resultInstruct != null){
					...
					//加点(bp)
					if(returnJson.resultInstruct.enWeightingValue != null && (returnJson.resultInstruct.enWeightingValue!= ""||returnJson.resultInstruct.enWeightingValue==0)
