...
public class Consts {
	...
	static {
		...
		try {
			...
			in = new FileInputStream(ApplicationContext.getInstance().getApplicationUserWorkingPath()+"/com.cjhxfund.ats.sm.comm/META-INF/properties/o32.properties");
					//Consts.class.getResourceAsStream();
			p.load(in);
	...
	public static String getLocalPath() {
		...
		params[0]="ZHFWPT_LOCAL_FOLDER_PATH_SM";
		//预防调用失败，赋予本地操作目录一个默认值
		String localPath = "/home/ats/FileProcess/zhongzhai_shangqing(sm)";
		try {
			...
			LogUtil.logError("从系统参数获取本地路径失败，使用默认路径: /home/ats/FileProcess/zhongzhai_shangqing(sm)", null, new Object[]{});
			e.printStackTrace();
		}
		return localPath;
	}
