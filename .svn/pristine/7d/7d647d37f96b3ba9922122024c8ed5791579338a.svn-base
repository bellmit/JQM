		   ...
		   <div class="search-condition">
			   <div class="list">
				 <form id="form_second_detail" method="post">
				 	...
				 	<%-- 查询类型 --%>
				 	<input class="nui-hidden" id="queryType" name="paramObject/queryType" value="SEVENTH_DETAIL_XJL">
				 	<%-- 单元编号(必传) --%>
...
<script type="text/javascript">
    ...
    //页面X的删除功能
		...
		function search_second_detail(){
			...
			if(colField=="stockBuyBal"||colField=="stockSaleBal"||colField=="bondBuyBalGuar"
