...
<body style="width:99.6%;height:99.6%;">
  <div class="search-condition">
	 <div class="list">
		<form id="form_XQJYLB" method="post" >
			<%-- 查询类型 --%>
			<input class="nui-hidden" name="paramObject/queryType" value="XQJYLB">
			...
			<table id="table1" class="table" style="height:100%;table-layout:fixed;">
				<tr>
					...
					<td >
						<input id="vcTradests_XQJYLB" class="nui-textbox"  name="paramObject/vcTradests" style="width:80%"/>
					</td>
					<td width="80px" align="right">
							证券简称:
					</td>
					<td >
						<input id="vcStocknm_XQJYLB" class="nui-textbox"  name="paramObject/vcStocknm" style="width:80%"/>
					</td>
					<td width="90px" align="right">
							买方持有人简称:
					</td>
					<td >
						<input id="vcBuyernm_XQJYLB" class="nui-textbox" name="paramObject/vcBuyernm" style="width:80%"/>
					</td>
				</tr>
				<tr>	
					<td align="right">
					...
					<td >
						<input id="vcBuyersts_XQJYLB" class="nui-textbox"  name="paramObject/vcBuyersts"  style="width:80%"/>
					</td>
					<td  align="right">
							卖方状态:
					</td>
					<td >
						<input id="vcSellersts_XQJYLB" class="nui-textbox" name="paramObject/vcSellersts" style="width:80%"/>
					</td>
					<td align="right">
							卖方持有人简称:
					</td>
					<td >
						<input id="vcSellernm_XQJYLB" class="nui-textbox"  name="paramObject/vcSellernm" style="width:80%"/>
					</td>
				</tr>
				<tr>
					<td  align="right">
					...
					<td>
						<input id="vcTxdt_XQJYLB" class="nui-datepicker"  allowInput="false" name="paramObject/vcTxdt" style="width:80%"/>
					</td>
					<td align="right">
							结算日期:
					</td>
					<td>
						<input id="vcSttlmdt_XQJYLB" class="nui-datepicker" name="paramObject/vcSttlmdt"  allowInput="false" style="width:80%"/>
					</td>
					<td  align="right">
							数据日期:
					</td>
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td width="80px" align="left">
						<input class='nui-button' plain='false' text="查询" iconCls="icon-search" onclick="search_XQJYLB()"/>
				</td>
...
<script type="text/javascript">
    nui.parse();
    var datagrid_XQJYLB = nui.get("datagrid_XQJYLB");
    var form = new nui.Form("#form_XQJYLB");
	var json = form.getData(false,false);
	datagrid_XQJYLB.load(json);//grid查询
	
	function search_XQJYLB(){
	    search(datagrid_XQJYLB, "#form_XQJYLB");
	}
	//全屏显示
	function fullScreen(){
		window.open('<%=request.getContextPath()%>/sm/comm/back_stage_trader/bst_xqjylb_detail.jsp','newwindow','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
	}
	//刷新
	//“今日待处理”模块自动刷新功能处理
