					...
					<table id="instrcutInfo" class="instructTable" border="0" cellpadding="1" cellspacing="2" style="width: 100%;">
						...
						<tr>
							...
							<td>
								...
								<input id="vcCounterpartyTrader" vtype="maxLength:64" class="nui-textbox" style="width: 125px;" 
								onvalidation="traderCheck" name="vcCounterpartyTrader"  required="true"/><!-- 对方交易员代码 -->
							</td>
