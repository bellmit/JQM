...
<body>
            ...
            <table class="instructTable" border="0" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td colspan="1" width="20%">
                        ...
                        format="yyyyMMdd" onvaluechanged="valueDateChange"/>
                    </td>
                </tr>
                <tr>
                	<td align="right" width="20%">
	...
	<script type="text/javascript">
		...
		$(function() {
	    	...
	    	showFile();
	    	var myDate = new Date();
	    	nui.get("lTradeDate").setValue(myDate);
	    	tradeDateChange();
		});	
    	...
    	function businNameChange(){
    		...
    		if(tradeDate!=null && tradeDate!=""){
    			//var valueDate = nui.get("lValueDate").getValue();
    			dateProcess(bsHead,bsTail,payCycle,tradeDate,null);
    		}
    	...
    	//时间联动
    	function dateProcess(bsHead,bsTail,payCycle,tradeDate,valueDate){
    		var dueDate = "";
    		nui.ajax({
						data:{tradeDate:tradeDate,bsHead:bsHead,bsTail:bsTail,payCycle:payCycle,valueDate:valueDate},
						async: false,
						type:'POST',
    	...
    	function valueDateChange(){
    		...
    		if(valueDate!=null && valueDate!=""){
    			if(bsNameValue!=null && bsNameValue!=""){
    				...
    				dateProcess(bsHead,bsTail,payCycle,tradeDate,valueDate);
    			}
    		}
    	}
