...
- Description:
    ...
    <div id="dataform1">
		<table style="width:100%; table-layout:fixed;margin: 0xp;padding: 10px;" id="table" border="0" class="">	
			<tr>
                <td style="width:100px; " align="right">持仓标签：</td>
                <td >
                	
               		
        				<input id="select2" name="tb" class="mini-autocomplete" required="true" style="width:200px;"
				    valueField="id" textField="text" 
				        url="com.cjhxfund.jy.ProductProcess.o32tcjc.queryLabelListTree.biz.ext?toplLabelId=1"  />
                </td>
             </tr>
          </table>
	</div>
        	...
        	function add(){
        		...
        		if(nodeId=="" && nodeText==""){
        		 ...
        		 nui.ajax({
		            ...
		            type: 'POST',
		            data: {adds:jsonData,nodeId:nodeId,nodeText:nodeText,pid:1},
		            cache: false,
