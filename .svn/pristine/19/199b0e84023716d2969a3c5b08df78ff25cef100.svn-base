	...
	<div id="instructDetail_grid">
        <table id="instruct_detail_from" class="nui-form-table" style="width:100%; heiht:100%">
            ...
            <tr>
				...
				<td>
					<input name="instructInfo.enSettleAmount" class="nui-spinner" minValue="0" maxValue="10000000000000000000000000000" format="n2" readonly/>
				</td>
            </tr>
            <tr>
                <td align="right"><span style="color: red">*</span>回购金额（万元）：</td>
                <td id="oldEnFaceAmount">    
                    <input name="instructInfo.enFaceAmount1" class="nui-textbox" required="true" readonly/>
                </td>
    ...
    <div title="质押券信息" id="mortgageInfoPanel" class="nui-panel" iconCls="icon-edit" style="width:100%;" 
		...
		<div id="datagrid_mortgage_info" dataField="mortgageInfos" 
			...
			<div property="columns">
				...
				<div field="enFaceAmount" width="100px" headerAlign="center" numberFormat="n4" align="center" ><span style="color:red;">*</span>券面金额（万元）</div>
        	...
        	<tr>
        		<td align="center" style="text-align:center;" colspan="3">
        			...
        			<span id="confirm" style="display:none">
        				<a class="nui-button" plain="false" iconCls="icon-ok" onclick="goConfirm_tg()">确认</a>
        				<span style="display:inline-block;width:25px;"></span>
        			</span>
