...
<div style="margin-bottom: 5px;">
        <div class="inputContainer" id="fullDirection">
            ...
            <ul>
                ...
                <li liType='input'><label><span>*</span>回购天数:</label>
                    <div>
                        <input class="nui-spinner" id="lRepoDays" required="true" name="lRepoDays"
                               onblur="caclSymbol(true,'5','5')" maxValue="91" onvalidation="lRepoDaysNum"
                               style="width: 100%;"/>
                    </div>
                </li>
                ...
                <li liType='input'><label><span style="color: red">*</span>对方交易员:</label>
        ...
        <div id="bondsGrid" class="nui-datagrid" style="width:100%;height:170px;"
            ...
            <div property="columns">
                ...
                <div field="enNetPriceInit" renderer="priceFixed" width="100" align="right" headerAlign="center"><span style="color:red;">*</span>
                   首次净价
                    <input property="editor"  onblur="updenNetPriceInit(e)" class="mini-textbox"  onenter="updenNetPriceInit(e)" style="width:100%;"/>
                </div>
...
<script type="text/javascript">
    ...
    function showHolding() {
        nui.open({
            url: "<%=request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/holding/buyoutHolding.jsp",
            title: "银行间债券持仓",
            width: 850,
            height: 520,
            allowResize: true,
...
<script type="text/javascript" src="<%=request.getContextPath()%>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/js/buyoutRepo.js"></script>
</body>
</html>