...
//文件保存目录路径(生产环境路径)
//String savePath ="/home/ats/FileUploadPath/JQM/LiuYanBan/";
//文件保存目录URL
//String saveUrl  ="/home/ats/FileUploadPath/JQM/LiuYanBan/";
...
if(serverType.equalsIgnoreCase("0") && serverType != null){
	savePath =  pageContext.getServletContext().getRealPath("/") + "attached/";
	saveUrl = request.getContextPath() + "/attached/";
}else{
	savePath  = pageContext.getServletContext().getRealPath("/") + ProductUtil.UPLOAD_FILE_PATH_LIUYANBAN;
	saveUrl  = request.getContextPath() + ProductUtil.UPLOAD_FILE_PATH_LIUYANBAN;
}
