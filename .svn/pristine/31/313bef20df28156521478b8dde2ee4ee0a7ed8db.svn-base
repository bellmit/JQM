...
<div style="margin-bottom: 5px;">
    ...
    <div style="height:auto;width:100%;">
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:80%;" align="left">
                        ...
                        <a class="nui-button" id="showHoldingButton"  enabled="true"  onclick="showHolding()" plain="true" iconCls="icon-search">从持仓选择</a>
                    </td>
                </tr>
            </table>
        </div>
        <div id="bondsGrid" class="nui-datagrid" style="width:100%;height:170px;"
             ...
             editNextOnEnterKey="true"  editNextRowCell="false"
    ...
    <div style="text-align: center;padding-top: 10px;">
		...
		<div style="text-align: center;float:left;width:95%;position: fixed;padding-right: 20px;">
    		...
    		<a class="nui-button" plain="true" iconCls="icon-save" id="exactCommit" onclick="saveDirective()">保存</a>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/js/repurchaseCommM.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/riskMgr/js/riskMgrComm.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/inquiry/inquiryResultManage/inquiryResultEntering/repurchase/js/collateraliseRepoM.js"></script>
</body>
</html>