...
<body style="height: 99%;">
 <div id="dataform1" style="height: 100%;">
   <div class="nui-tabs" id="tabs" activeIndex="0"  style="width:100%;height:100%;">
			   ...
			   <table style="width:100%;table-layout:fixed;" class="nui-form-table">
				...
				发行方式:
		                ...
		                <tr>
						  ...
						  <td colspan="1">
						    <input class="nui-hidden" id="vcAbsType" width="220px" name="stockissueinfo.vcAbsType" value="<b:write property="firstGradeBond/vcAbsType" />" readonly="readonly"/>
					  ...
					  <td colspan="1"  >
					  	<input class="nui-hidden" id="vcIssueAppraiseProspect" width="220px" name="stockissueinfo.vcIssueAppraiseProspect" value="<b:write property="firstGradeBond/vcIssueAppraiseProspect" />" readonly="readonly"/>
					  </td>
					</tr>
		...
		<div title="审批内容">
		   <%@include file="/fm/instr/firstGradePayment/processDonePayment.jsp" %>
		</div>
