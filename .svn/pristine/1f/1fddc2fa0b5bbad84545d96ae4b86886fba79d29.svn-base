		   ...
		   <div class="search-condition">
			   <div class="list">
				 <form id="form_second_detail" method="post">
				 	...
				 	<%-- 查询类型 --%>
				 	<input class="nui-hidden" id="queryType" name="paramObject/queryType" value="SIXTH_DETAIL_XJL">
				 	<%-- 单元编号(必传) --%>
           ...
           <div class="nui-fit">
           		<div  id="datagrid_second_detail"
                	...
                	<div property="columns">
	                    ...
	                    <div field="trusteeShip" headerAlign="center"  align="left" width="90px">
                                    	托管机构
	                    </div>
	                    <div field="entrustDirection" headerAlign="center"  align="left" width="90px">
                                    	委托方向
	                    </div>
	                    ...
	                    <div field="tradeRivalName" headerAlign="center"  align="left" width="180px">
                                    	交易对手
	                    </div>
...
<script type="text/javascript">
    ...
    //页面X的删除功能
		...
		function search_second_detail(){
			...
			if(colField=="bondBuyBalCibm"||colField=="bondSaleBalCibm"||colField=="rzhgBalCibm"
			   ||colField=="rzhgExpireBalCibm"||colField=="rqhgBalCibm"||colField=="rqhgExpireBalCibm"
			   ||colField=="netStlBalCibm"){
				nui.get("type").setValue("1");
				nui.get("vcMarket").setValue("5");//银行间
			}
		...
		grid_second_detail.on("drawcell", function (e) {
			...
			if(field == "occurBal"){
				if(record.trusteeShip == "中债登"){
					zzdsum = add(zzdsum,record.occurBal);
				}else if(record.trusteeShip == "上清所"){
					sqssum = add(sqssum,record.occurBal);
				}
			}
			var s = "<div style='color:Brown;'>";
	        	...
	        	s+="银行间总金额: "+formatNumber(add(zzdsum,sqssum),2,1)+"</div>";
