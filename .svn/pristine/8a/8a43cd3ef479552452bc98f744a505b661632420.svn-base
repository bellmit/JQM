				...
				<table id="table1" class="table">
					<tr>
						...
						<td class="btn-wrap" style="width:60px;">
							<input class='nui-button' plain='false' iconCls="icon-search" text="查询" onclick="search" />
						</td>
					</tr>
				</table>
			</div>
	...
	<div style="padding:10px 5px 0px 5px;">
		 <div class="nui-toolbar" style="border-bottom:0;">
			<table style="width:100%">
				<tr>
					<td>
						<a class='nui-button' plain='false' iconCls="icon-add" onclick="addRole">增加</a>
						<a class='nui-button' plain='false' id="btnEdit" iconCls="icon-edit" onclick="updateRole">编辑</a>
						<a class='nui-button' plain='false' iconCls="icon-remove" onclick="removeRole">删除</a>
					</td>
				</tr>
			</table>
		</div>
