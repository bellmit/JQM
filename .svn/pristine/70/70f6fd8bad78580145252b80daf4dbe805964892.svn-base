...
<fieldset>
		...
		<div id="oldInstructInfo" style="padding-top: 5px; height: auto; width: 100%;">
			...
			<div class="infoLabel2">
				<label> 回购天数 </label><input id="lRepoDays" class="nui-textbox" onblur="calFirstMaturityRe()" vtype="int" />
			</div>
			<div class="infoLabel2">
...
<!-- 					class="nui-textbox" /> -->
			...
			<div class="infoLabel2">
				<label> 对方交易员 </label><input id="vcCounterparty"
					class="nui-textbox" />
			</div>
			<div class="infoLabel2">
			...
			<div class="infoLabel2">
				<label> 回购利率(%) </label><input id="enRepoRate"
					class="nui-textbox" vtype="float" required="true" onblur="calEmFaceAmount()"/>
			</div>
	...
	<fieldset>
		...
		<div id="DirectionInfo"
			...
			<div class="infoLabel2">
				<label> 质押比例(%) </label><input id="enMortagageRatio" class="nui-textbox" onblur="calEmFaceAmount()"/>
			</div>
			<div class="infoLabel2" style="width: 100%;">
...
//         var bond = instructParameter.bond;
    ...
    function calEmFaceAmount() {
        ...
        var enFaceAmount = nui.get("enFaceAmount").getValue();
        var enRepoRate = nui.get("enRepoRate").getValue();
        var enRatio = nui.get("enMortagageRatio").getValue();
        ...
        //计算回购利息
        var interest = div(mul(mul(lContractPeriods, enFaceAmount), enRepoRate), 100 * 360);
        enRepoInterest.setValue(interest);
        //计算到期结算金额
        nui.get("enSettleAmount").setValue(add(interest, mul(enFaceAmount, enRatio / 100)));
