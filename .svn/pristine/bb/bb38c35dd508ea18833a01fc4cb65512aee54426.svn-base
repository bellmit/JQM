...
<body>
 <div style="width:100%;height:100%; "  borderStyle="border:solid 1px #aaa;">
	<div style="height:10px;">
	                 &nbsp;&nbsp;导入文件路径：
	     <input width="300px" id="fileupload1" class="nui-fileupload" name="Fdata"
		flashUrl="../../../fm/comm/fileupload/js/swfupload.swf" 
    	...
    	*/
	    ...
	    function startUpload() {
	    	if(startUploadfunc!="" && startUploadfunc!=null){
	    		//调用父界面校验函数验证
	    		window.parent[startUploadfunc](nui.get("fileupload1"));
	    	}
