...
<table style="width:100%;table-layout:fixed;" border="0" class="nui-form-table">
	...
	<tr>
		...
		<td colspan="2" class="radio-border-top-none">
			...
			<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_YY,ATS_FM_TZJYLR,ATS_FM_TGLR,ATS_FM_TGFH,ATS_FM_WTRFH,ATS_FM_TZJYLR">
				<input name="bpsParam.operateType" id="operateType" class="nui-radiobuttonlist" onitemclick="operateCheck(this)" 
					data="[{id: 1, text: '同意'} ,{id: 2, text: '退办'},{id: 3, text: '转办'},{id: 4, text: '征求意见'},{id: 5, text: '否决'}]"  value="1"/>
				</l:notIn>
		...
		<td class="td1">
		  <l:in property="pageType" targetValue="1">
				<l:in property="workitem/activityDefID" targetValue="ATS_FM_XXHD1">   
				    <a class='nui-button' plain='false' iconCls="icon-save" onclick="tempSaveData()">暂存</a>
				</l:in>	
				<a class='nui-button' plain='false' iconCls="icon-save" onclick="processSubmit(false)">提交</a>
				...
				<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_TGLR,ATS_FM_TGFH,ATS_FM_WTRFH,ATS_FM_XXHD1,ATS_FM_XXHD2,ATS_FM_TZJLFH,ATS_FM_ZJZLSP,ATS_FM_FKRGSH,ATS_FM_TBYY,ATS_FM_CZ_ZBQR">
					<l:in property="checkrole" targetValue="1">
						<span style="display:inline-block;width:5px;"></span>
				...
				<l:in property="workitem/activityDefID" targetValue="ATS_FM_CZ_ZBQR">
					<l:in property="checkrole" targetValue="1">
						<span style="display:inline-block;width:5px;"></span>
						<a class='nui-button' plain='false' id="aSendFaxes" iconCls="icon-download" onclick="sendFaxes()">发送传真</a>
					</l:in>
				</l:in>	
				<l:in property="workitem/activityDefID" targetValue="ATS_FM_CZ_TBZX,ATS_FM_CZ_ZBQR,ATS_FM_CZ_CZZZCXS,ATS_FM_CZ_FSZCXS">
					<l:in property="checkrole" targetValue="1">
						<span style="display:inline-block;width:5px;"></span>
	...
	<tr>
		...
		<td colspan="3" class="radio-border-top-none td2" style="border-bottom: 1px solid #D3D3D3;"> 
			<input name="bpsParam.yn" id="ynZB" class="nui-radiobuttonlist" 
	...
	<!-- 中标复核环节 ,中标确认-->
	<l:in property="workitem/activityDefID" targetValue="ATS_FM_CZ_ZBFH,ATS_FM_CZ_ZBQR"> 
		<l:in property="checkrole" targetValue="1">
			<tr>
				<td class="td1 " width="20%" style="border-bottom: 1px solid #D3D3D3;" align="right">用印方式:</td>
				<td colspan="3" class="radio-border-top-none td2" style="border-bottom: 1px solid #D3D3D3;"> 
					<input name="bpsParam.yn" id="ynYY" class="nui-radiobuttonlist" onitemclick="operateCheck1(this)"
	...
	<tr>
		...
		<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_CZ_ZBFH">
		   <td colspan="1" class="td2"><input id="comments" class="nui-textarea" name="pmprcaprvinfo.vcComments" width="450" height="60" value="同意"/></td>
		</l:notIn> -->
	...
	<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_CZ_TBZX">
		<tr>
...
<!-- 			<input class="nui-textbox" name="bpsParam.FaxNumber" id="FaxNumber" onvaluechanged="checkFax" width="80%"/> -->
	...
	<l:in property="workitem/activityDefID" targetValue="ATS_FM_CZ_TBZX,ATS_FM_CZ_ZBQR"> 
	<!-- 邮件信息 -->
		<l:in property="checkrole" targetValue="1">
		<tr>
...
<div>
	...
	<form id="word_download" method="post">
		...
		<!-- 下载方式：1是投资指令/建议管理，和申购中标确认前下载，否则为中标确认后的审批页面下载 -->
...
<script>
  //用印环节用印，双击打开文档
    ...
    //中标确认节点需判断是否招行产品来显示传真按钮
   var activityDefID = '<%=activityDefID %>';   //获取活动定义ID
  
   var checkrole='<b:write property="checkrole"/>';
    if(activityDefID=="ATS_FM_CZ_ZBQR" && checkrole!="1"){
         var productCode='<%=vcProductCode %>';
         var json = nui.encode({vcProductCode:productCode});
			$.ajax({
				url:"com.cjhxfund.ats.fm.instr.FirstGradeBond.isProductType.biz.ext",
				type:'POST',
				data:json,
				contentType:'text/json',
