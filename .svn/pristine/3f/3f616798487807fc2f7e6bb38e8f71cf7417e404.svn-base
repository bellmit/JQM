        ...
        <div id="dataform1" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" width="100%" height="120" name="ProductInvestmentRange.voteRange" readonly/>
                ...
                <tr>    
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" width="100%" height="120" name="ProductInvestmentRange.noCastRange" readonly/>
                ...
                <tr>     
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" width="100%" height="120" name="ProductInvestmentRange.investmentLimit" readonly/>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" width="100%" height="120" name="ProductInvestmentRange.remarks" readonly/>
                    </td>
                </tr>
            </table>
        </div>
