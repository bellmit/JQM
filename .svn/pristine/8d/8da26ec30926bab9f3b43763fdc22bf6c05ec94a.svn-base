...
<link href="../../../fm/comm/fileupload/css/default.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="../../../fm/comm/fileupload/css/button.css" type="text/css" />
...
<%
 ...
 %>
<body>
	<div id="form1" class="nui-form" align="left" style="width: 99.7%; height: 100%; border:1px solid #99BCE8;">
		...
		<div id="fileUpBtn" style="width: 100%;" foren>
			<span id="spanButtonPlaceholder"></span>
			<a id="removeButton" class='nui-button' plain='false' iconCls="icon-remove" onclick="deletefiles()"	plain="false">删除</a>
			<font style="color: red; margin-left:240px;"></font> 上传文件，最大上传50M文件 ！
		</div>
		<div id="datagridupload" dataField="attachments" class="nui-datagrid"
			style="width: 100%;height:154px;  display: block;border: 1px solid red;"
...
<script type="text/javascript">
	...
	if(vcType!="null"){
		document.getElementById("fileUpBtn").style.display="none";
		document.getElementById("form1").style.border="0";
	}
	function inIt() {
	...
	window.onload = function() {
	    ...
	    var url = "upload.jsp?attachType="+attachType+"&attachBusType="+attachBusType+"&bizId="+bizId+"&usreId="+userId;
		...
		swfu = new SWFUpload({
			...
			button_image_url: '../../../fm/comm/fileupload/image/button.png',

			// Flash Settings
			flash_url : "../../../fm/comm/fileupload/js/swfupload.swf",
