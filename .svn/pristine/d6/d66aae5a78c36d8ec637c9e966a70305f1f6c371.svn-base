...
<body>
	...
	<div id="form_ZDHTCBDetail" class="nui-form" style="padding:2px;" align="center" style="height:10%">
	 	...
	 	<%-- 查询类型 --%>
	 	<input id="queryType" class="nui-hidden" name="paramObject/queryType" value="ZDHTCBDetail">
	 	<%-- 基金序号 --%>
	...
	<script type="text/javascript">
		...
		function setFormData(data){
		    ...
		    if(rowType=="real"){
		        nui.get("queryType").setValue("ZDHTCBDetail");
		    }else{
		        nui.get("queryType").setValue("ZDHTCBDetail2");
		    }
	    	search_ZDHTCBDetail();
		}
