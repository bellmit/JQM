	...
	<script type="text/javascript">
	   ...
	   <%-- 大宗交易业务 --%>
	    ...
	    grid_DZJY.on("rowdblclick", function (e) {
	    	rowdblclickFun("JY_DZJY/CFJYProductProcessForm_detailOperator_show_DZJY.jsp", "大宗交易明细展示", 600, 387, e, grid_DZJY);
	    });
	    //新增
	    function add_DZJY(){
	    	add("JY_DZJY/CFJYProductProcessForm_DZJY.jsp", "大宗交易新增记录", 600, 387, grid_DZJY);
	    }
	    //编辑
		function edit_DZJY(){
			edit("JY_DZJY/CFJYProductProcessForm_DZJY.jsp", "大宗交易编辑数据", 600, 387, grid_DZJY);
		}
		//废弃
		...
		//全屏显示
		function fullScreen(){
			window.open('<%=request.getContextPath()%>/ProductProcess/JY_DZJY/CFJYProductProcessList_DZJY.jsp','newwindow','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
		}
