...
<body style="height: 99%;">
 <div id="dataform1" style="height: 100%;">
                ...
                <tr>
                   <td class="form_label td1" align="right">
                    ...
                    <td colspan="1" class="radio-border-top-none">
                       ...
                       <input class="nui-textbox" name="cfjybusinessbonetable.resaleYear"  width="45"
                    ...
                    <td colspan="1" class="radio-border-top-none td2">
                        <input id="redemptionRight" class="nui-dictradiogroup" name="cfjybusinessbonetable.redemptionRight" 
                         dictTypeId="COF_YESORNO" style="float: left;" onvaluechanged="redemptionRightOnvaluechanged(e)" value="<b:write property="cfjybusinessbonetable/redemptionRight" />" readonly/>
                          ...
                          <input class="nui-textbox" name="cfjybusinessbonetable.redemptionYear" 
                ...
                <tr>
                  ...
                  <td colspan="3" style="padding: 0px;margin: 0xp;" class="td2">
                   <p class="p"><label style="margin-left: 5px;font-weight: inherit;">该笔债券投资占发行规模比例(%): </label>
                   				<input name="cfjybusinessbonetable.investmentOccupyIssuesize" id="investmentOccupyIssuesize" class="nui-textbox asLabel"  value="<b:write property="cfjybusinessbonetable/investmentOccupyIssuesize" />" readonly/></p>
                   <p class="p"><label style="margin-left: 5px;font-weight: inherit;">同一发行人占产品净值规模比例(%): </label>
                   				<input name="cfjybusinessbonetable.productEquityRatio" id="productEquityRatio" class="nui-textbox asLabel" value="<b:write property="cfjybusinessbonetable/productEquityRatio" />" readonly/></p>
                   <p class="p"><label style="margin-left: 5px;font-weight: inherit;">该笔债券投资占产品净值规模比例(%): </label>
                   				<input name="cfjybusinessbonetable.bondOccupyProductRatio" id="bondOccupyProductRatio" class="nui-textbox asLabel" value="<b:write property="cfjybusinessbonetable/bondOccupyProductRatio" />" readonly/></p>
                   <p><label style="margin-left: 5px;font-weight: inherit;">弱流动性资产规模占产品净值规模比例(%): </label>
                   				<input name="cfjybusinessbonetable.weakLiquidityRatio" id="weakLiquidityRatio" class="nui-textbox" value="<b:write property="cfjybusinessbonetable/weakLiquidityRatio" />" readonly/></p>
                  </td>
                </tr>
                <tr>
   ...
   <script type="text/javascript">
     ...
     var activityDefID = '<b:write property="workitem/activityDefID" />';     //环节活动定义ID
	 ...
	 function processSubmit(){
	    ...
	    if(activityDefID == "manualActivity3"){
		   urlStr = contextPath + "/com.cjhxfund.jy.process.cfjybusinessbonetablebiz.FirstGradeBondFKJC.biz.ext";
		}else{
		   urlStr = contextPath + "/com.cjhxfund.jy.process.cfjybusinessbonetablebiz.firstGradeBondXXHD.biz.ext";
		}
		//流程js验证
