        ...
        <div class="main">
            ...
            <form id="form1" method="post" >
		        ...
		        <fieldset class="fieldset">
	            	<legend>&nbsp;&nbsp;操作 &nbsp;&nbsp;</legend>
			        <!--指派研究员-->
			        <ul class="form_file" style="height:40px;">
			        	<li>
	                        <span class="info_name">指派研究员:</span>
	                    </li>
		                <li id="btnEdit">
			       			<input id="btnEdit1" class="nui-buttonedit" onbuttonclick="onButtonEdit" allowInput="false"required="true"/>
			       			<input id="searcherName" name="ipoInstructInfo.searcherName" class="nui-textbox"/>
			           	</li>
			        </ul>
			        <!--附件下载-->
            		<ul class="form_file">
	...
	<script type="text/javascript">
	    ...
	    (function(){
	    	...
	    	if(vcType!="null"){
	    		...
	    		document.getElementById("searcherName").style.display="none";
	    	}
	    })();
    	//指派研究员
        function onButtonEdit(e) {
            var btnEdit = this;
            nui.open({
                url:"<%= request.getContextPath() %>/ipo/offering/enquiryAssignSelectWindow.jsp?processInstID="+processInstID,
                title: "选择研究员",
                width: 300,
                height: 380,
