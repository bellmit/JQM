	...
	<div class="nui-panel" title="业务字典类型" style="width:100%;height:100%;"
		...
		<table border="0" style="width:100%;" align="center">
			<tr>
				...
				<td><a class='nui-button' plain='false' onclick="searchDictType();">查询</a></td>
			</tr>
	  ...
	  <div style="margin:10px 0px 0px 0px;">
	    <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
	      <table style="width:100%;">
	        <tr>
	           <td style="width:100%;">
			<a class='nui-button' plain='false' iconCls="icon-add" onclick="addDictType()" >添加</a>
			<a class='nui-button' plain='false' iconCls="icon-addnew" onclick="addSubDictType()" id="btn_addSubDictType">添加子类型</a>
	        <a class='nui-button' plain='false' iconCls="icon-edit" onclick="editDictType()" id="btn_editDictType">修改</a>
            <a class='nui-button' plain='false' iconCls="icon-remove" onclick="removeDictType()" id="btn_removeDictType">删除</a>
			<a class='nui-button' plain='false' iconCls="icon-upload" onclick="importDict();">导入</a>&nbsp;
			<a class='nui-button' plain='false' iconCls="icon-download" onclick="exportDict();">导出</a>&nbsp;
			<a class='nui-button' plain='false' onclick="refreshDictCache();">刷新缓存</a>
	           </td>
	        </tr>
	      </table>
	    </div>
...
<td style="height:100%;" rowspan="2" valign="top">
	...
	<div class="nui-panel" title="业务字典项" style="width:100%;height:100%;"
		...
		<div property="toolbar" >
	        <a class='nui-button' plain='false' iconCls="icon-add" onclick="addDict()" >添加</a>
			<a class='nui-button' plain='false' iconCls="icon-addnew" onclick="addSubDict()" id="btn_addSubDict">添加子项</a>
	        <a class='nui-button' plain='false' iconCls="icon-edit" onclick="editDict()" id="btn_editDict">修改</a>
            <a class='nui-button' plain='false' iconCls="icon-remove" onclick="removeDict()" id="btn_removeDict">删除</a>
	    </div>
...
<div id="importWindow" class="nui-window" title="Window" style="width:650px;" 
    ...
    <div title="业务字典导入" >
        ...
        <table border="0" style="width:500px;height:100px;" align="center">
			...
			<tr align="center">
				<td colspan="2">
					<a class='nui-button' plain='false' onclick="startUpload();">导入</a>&nbsp;
					<a class='nui-button' plain='false' onclick="resetImport();">重置</a>&nbsp;
					<a class='nui-button' plain='false' onclick="cancelImport();">取消</a>
				</td>
			</tr>
        </table>
        </form>
