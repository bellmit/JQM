...
<div class="search-condition" style="height:80px;">
    <div id="vunitstockCondition" class="searchBox">
        ...
        <div class="searchDiv">
            <label>产品名称:</label>
            <div name="fundCodeName" class="nui-autocomplete" pinyinField="ID" id="fundCodeName"
...
<div id="vunitstockGrid" dataField="vunitstockList"
    ...
    <div property="columns">
        ...
        <div field="vcAvailablequantityT0" align="left" width="100" allowSort="true" dataType="int" decimalPlaces="0" numberFormat="n0" headerAlign="center">
            T+0可质押数量
        </div>
        <div field="vcAvailablequantityT1" align="left" width="100" decimalPlaces="0" headerAlign="center" allowSort="true" dataType="int" numberFormat="n0">T+1可质押数量</div>
...
<script type="text/javascript">
    ...
    var selectFund = function (e) {
        ...
        $.ajax({
            data: {vcProductCode: id,vcRelate:"('03')"},
            url: "com.cjhxfund.commonUtil.applyInstUtil.QueryCombiInfobyRalate.biz.ext",
                ...
                for (var i = 0; i < VunitData.length; i++) {
                        ...
                        for (var j = 0; j < avaiList.length; j++) {
                            ...
                            if (row.vcCombiCode == ava.VC_ACCOUNT && row.vcReportCode == ava.VC_SYMBOL) {
                                var vcAvailablequantityT0Temp = ava.VC_AVAILABLEQUANTITY_INQUIRY_T0;
                                var vcAvailablequantityT1Temp = ava.VC_AVAILABLEQUANTITY_INQUIRY_T0;
	    ...
	    for(var b = 0;b<rows.length;b++){
	    	...
	    	for(var c = 0;c<bondData.length;c++){
	    		...
	    		if((r.vcStockCode === bon.vcStockCode) &&  (r.vcExchange === bon.vcExchange)){
	    			bool = false;
	    			remindStr = remindStr + "<br/>不能重复选择债券！("+ r.vcReportCode +")";
	                break;
	    		}
	    	}
	    }
