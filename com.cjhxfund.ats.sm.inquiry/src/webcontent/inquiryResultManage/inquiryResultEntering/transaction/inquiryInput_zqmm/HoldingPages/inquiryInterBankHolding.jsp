...
<body>
	...
	<div class="search-condition">
		<div class="list">
			<div id="bank_between_instruct_condition" class="nui-form" style="padding:2px;height:10%;" align="left">
				<input class="nui-hidden"  name="vcMarket" value="OTC" id="vcMarket"/>
				<input class="nui-hidden"  name="businClass" value="2" id="businClass"/>
				<input class="nui-hidden"  name="vcEntrustDirection" value="4" id="vcBusinType"/>
				<input class="nui-hidden"  name="vcInvestType" value="1" id="vcInvestType"/>
				<input class="nui-hidden"  name="vcMarketNo" value="5" id="vcMarketNo"/>
				<table border="0" cellpadding="1" cellspacing="1" style="width:100%;table-layout:fixed;">
					...
					<tr>
						...
						<td align="left">
							<input class="nui-textbox" id="minLimiteLeft" name="minLimiteLeft"  vtype="float"  onvalidation="numberCheck" requiredErrorText="必须是整数" style="width:45%;"/>
							<span style="width:5%;">-</span>
							<input class="nui-textbox" id="maxLimiteLeft" name="maxLimiteLeft"  vtype="float"  onvalidation="numberCheck" requiredErrorText="必须是整数" style="width:45%;" />
						</td>
						<td align="left">
	...
	<div  class="nui-fit">
		...
		<div property="columns" >
			...
			<div field="lCurrentAmount" headerAlign="center" align="right" width="85px" allowSort="true" dataType="int" numberFormat="#,0" >
				持仓数量
			</div>
			<div field="vcAvailablequantityT0" headerAlign="center" align="right" width="92px" allowSort="true" dataType="int" numberFormat="n0" >
				T+0可卖数量
			</div>
			<div field="vcAvailablequantityT1" headerAlign="center" align="right" width="85px" allowSort="true" dataType="int" numberFormat="n0" >
				T+1可卖数量
			</div>
	...
	<script type="text/javascript">
    	...
    	function clicksearch(e,text){
    		if(e){
				var positionInfo = conditionForm.getRow(parseInt(e));    //点买入或卖出的传参
    	...
    	function SetSearchField(data){
    		...
    		if(data.vcProductCode){
    			nui.get("vcFundCode").setEnabled(false);
    		}
    		if(data.vcCombiCode){
    			nui.get("vcCombiNo").setEnabled(false);
    		}
    		search();
    	}
        $(function(){
