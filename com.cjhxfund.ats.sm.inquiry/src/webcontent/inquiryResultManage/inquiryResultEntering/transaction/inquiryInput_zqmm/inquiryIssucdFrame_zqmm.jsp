...
<body style="padding-top: 10px;overflow: hidden;">
	<div class="container" style="height:100%;width:100%;">
		...
		<div id="tabs" class="nui-tabs" style="height:461px; width:570px;float:right;margin-right: 10px;" onactivechanged="tabChange">
		    <div title="银行间债券市场" url="<%= request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultEntering/transaction/inquiryInput_zqmm/inquiryInput_zqmm_yhj.jsp" index="0" >
		    </div>
		    <div title="上交所固收平台" url="<%= request.getContextPath() %>/inquiry/inquiryResultManage/inquiryResultEntering/transaction/inquiryInput_zqmm/shFixIncome_zqmm_sjs_gs.jsp" index="1">
		    </div>
	...
	<script type="text/javascript">
		...
		//复制新增初始化页面及数据
    	function initWin(tabIndex,data,inquiryOperator){
			...
			activeTab.onload = function (e) {        
	            ...
	            if(data!=null){
		            ...
		            iframe.contentWindow.SetData(data,inquiryOperator);
	            }
        	};
    	}
	</script>
