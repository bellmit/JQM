...
import com.cjhxfund.ats.fm.baseinfo.ExcelTemplate;
import com.cjhxfund.ats.fm.baseinfo.ExcelUtilConfiguration;
...
public class ExcelUploadUtil {
	...
	private static String exportExcel(DataObject[] exportObjects,DataObject exportInfo,String templateFilename,boolean autoPagination,boolean autoSheet,String id) throws Exception{
		...
		String excelExportMaxnum=ConfigurationUtil.getContributionConfig(ExcelUtilConfiguration.CONTRIBUTION_ABFRAME_UTILS,
				ExcelUtilConfiguration.MODULE_ABFRAME,
				ExcelUtilConfiguration.GROUP_EXCEL,
				ExcelUtilConfiguration.EXCEL_EXPORT_MAXNUM);//10000
		...
		if(key!=null){//说明是导出到O32的
			...
			if(id!=null){
				...
				filedir = filedir.replaceAll(replaceFileName+"/", "export/"+replaceFileName+"/");///home/ats/atsxls/YYYYMMDD/export/ATS_CJ_ZQXX_YYYYMMDD.XLS
			}
