...
<body style="margin: 0px;padding: 0px;overflow: hidden;width: 100%;height: 100%;" onload="onloadFun()">
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">
                            ...
                            &nbsp;
                            <a id="goBack_ZJZT" class='nui-button' plain='false' iconCls="icon-no" onclick="goBack_ZJZT()">
								退回
                            </a>
                        </td>
                    </tr>
	...
	<script type="text/javascript">
	    ...
	    grid_ZJZT.on("rowdblclick", function (e) {
	    	rowdblclickFun("JY_ZJZT/CFJYProductProcessForm_show_ZJZT.jsp", "追加提取明细展示", 700, 430, e, grid_ZJZT, "JY_ZJZT/CFJYProductProcessForm_ZJZT.jsp");
	    });
	    //确认
	    ...
	    function selectionChanged_ZJZT(){
	        selectionChanged(grid_ZJZT, "confirm_ZJZT");
	    }
