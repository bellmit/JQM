...
<body style="width:99.6%;height:99.6%;" onload="reloadWaitConfirmFun()">
<div style="margin:0px 2px 0px 2px;width:100%;height:100%;" >
	<div class="nui-tabs" id="tab" activeIndex="0" style="width:100%;height:100%;">
	   ...
	   <!-- 待办 -->
       <div title="申购缴款" url="<%=request.getContextPath() %>/process/frameWork.jsp" refreshOnClick="true"></div>
       <!-- 已办 -->
       <%-- <div title="流转中流程" url="<%=request.getContextPath() %>/process/peding_QueryFrom.jsp" refreshOnClick="true"></div>       --%>
...
<script type="text/javascript">
	...
	function activechangedFun(){
      ...
      function setUpTabTitle(i){
        var activeTabTitle = nui.get("tab").getActiveTab();
        tabCmp.updateTab(activeTabTitle, {title:"待处理任务("+i+")"});
      } 
</script>
</body>
</html>