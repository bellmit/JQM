...
<div style="margin:0px 2px 0px 2px;width:100%;height:100%;" >
	<div id="tab" activeIndex="0" onactivechanged="activechangedFun" style="width:100%;height:100%;">
		            ...
		            <table id="table_TCYCCX" class="table" style="height:100%;table-layout:fixed;">
				            	<tr>
					                ...
					                <td style="width:6%" align="left">
					                    <input id="interval_TCYCCX" width="100%" class="nui-combobox" 
					                ...
					                <td style="width:8%" align="left">
					                    <input id="dateOne" width="100%" class="nui-datepicker" allowInput="false" name="paramObject/dateOne" />
									</td>
									<td width="10px" align="center">
										<span>-</span>
									</td>
									<td style="width:8%" align="left">	
										<input id="dateTwo" width="100%" class="nui-datepicker" allowInput="false" name="paramObject/dateTwo" />
					                </td>
					        		<td class="form_label" width="60px" align="right">
											产品名称:
					                </td>
					                ...
					                <td colspan="1" width="120px" align="left">
           ...
           <div class="nui-fit">
	            ...
	            <div header="沪港通" headerAlign="center">
	                <div property="columns">
                        <div field="stockBuyBalHgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					证券买入
                        </div>
                        <div field="stockSaleBalHgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					证券卖出
                        </div>
                        <div field="riskBalHgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					风控资金
                        </div>
                    </div>
	            </div>
	            <div header="深港通" headerAlign="center">
	                <div property="columns">
                        <div field="stockBuyBalSgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					证券买入
                        </div>
                        <div field="stockSaleBalSgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					证券卖出
                        </div>
                        <div field="riskBalSgt" headerAlign="center" dataType="currency" align="right" width="130px">
	  					风控资金
                        </div>
                    </div>
	            </div>
	            <div header="TA业务" headerAlign="center">
	                <div property="columns">
                        <div field="applyTaBal" headerAlign="center" dataType="currency" align="right" width="130px">
	  					申购
                        </div>
                        <div field="redeemTaBal" headerAlign="center" dataType="currency" align="right" width="130px">
	  					赎回
                        </div>
                        <div field="dividendTaBal" headerAlign="center" dataType="currency" align="right" width="130px">
	  					分红
                        </div>
                    </div>
	            </div>
	            		<div field="vatBal" headerAlign="center" dataType="currency" align="right" width="130px">
	  					增值税
                        </div>
...
<script type="text/javascript">
	...
	nui.get("beginDate").setValue(preDate);
	nui.get("endDate").setValue(preDateOne);
