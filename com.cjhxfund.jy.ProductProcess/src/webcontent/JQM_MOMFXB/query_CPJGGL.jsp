...
<div id="layout1" class="nui-layout" style="width:100%;height:100%;">
	<div title="产品树管理" region="west" bodyStyle="overflow:hidden;" width="240" class="sub-sidebar" allowResize="false">
...
<script type="text/javascript">
	...
	$(function() {
	    ...
	    var rootNode = {nodeName: "产品树", nodeType: "Root", isLeaf: false, expanded: false, iconCls: "icon-keywords"};
    ...
    function onBeforeTreeLoad(e) {
    	e.url = "com.cjhxfund.jy.momReport.reportManager.queryTreeChildNodes.biz.ext";
	...
	// 根结点对应的Tab页
	var employee_index = { title: '产品信息', url: '<%=contextPath%>/ProductProcess/PRODUCT_TREE/prod_list.jsp' };
	
	// 机构结点对应的Tab页
	/*var org_add = { title: '新增产品', url: '<%=contextPath%>/coframe/org/organization/prod_add.jsp' };*/
	...
	// 树结点类型与Tab页面的映射
	var orgTabs_map = {
		<%=SuperAdminService.currUserIsSupserAdmin()?"Root: [employee_index],":""%>
		ProductTree: [employee_index]
	};
	...
	// 机构右键菜单
	var prodMenu = [
		/*{text: "增加下级产品", onclick: "onAddOrgOfOrg", iconCls: "icon-add"},
		{text: "删除本级产品", onclick: "onRemoveOrg", iconCls: "icon-remove"},*/
		{text: "刷新", onclick: "onRefreshNode", iconCls: "icon-reload"}
	];
