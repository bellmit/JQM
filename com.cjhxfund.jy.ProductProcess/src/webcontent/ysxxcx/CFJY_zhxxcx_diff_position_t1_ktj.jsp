                ...
                <table id="table1" class="table" style="height:100%;table-layout:fixed;">
                	<tr>
                        ...
                        <td align="right" colspan="10">
                            <input class='nui-button' plain='false' text="查询" iconCls="icon-search" onclick="search_T1KTJZYQ(true)"/>
            ...
            <div 
            	  ...
            	  交易市场
	  			  ...
	  			  折算T+0标准券数量      
                        ...
                        <div field="L_CONVERTED_STANDARD_AMOUNT_NEXT" headerAlign="center" align="right" width="120px">
	  			  折算T+1标准券数量      
                        </div>
