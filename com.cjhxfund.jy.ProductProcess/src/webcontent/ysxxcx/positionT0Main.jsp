...
<div style="margin:0px 2px 0px 2px;width:100%;height:100%;" >
	<div  title="当日T+0头寸差额" class="nui-fit">
	...
	<script type="text/javascript">
		...
		//abs.removeAll();
		//设置tab属性
		var tab = {title:"银行间可用质押券明细", url:"<%=request.getContextPath() %>/ProductProcess/ysxxcx/CFJY_zhxxcx_diff_position_t0_yhj.jsp", showCloseButton: false };
		//设置tab
		tabs.addTab(tab);
		tabs.activeTab(tab);
	   
		var tab = {title:"交易所非担保交易债券明细", url:"<%=request.getContextPath() %>/ProductProcess/ysxxcx/CFJY_zhxxcx_diff_position_t0_jys.jsp", showCloseButton: false };
		tabs.addTab(tab);
