        ...
        <div id="dataform1" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-dictcombobox" dictTypeId="CF_JY_PRODUCT_PROCESS_PROCESS_TYPE_TYCQ" name="cfjyproductprocess.processType" emptyText="---请选择---" nullItemText="---请选择---" showNullItem="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label" width="23%">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-dictcombobox" dictTypeId="CF_JY_PRODUCT_PROCESS_EARLY_WITHDRAWAL_CLAUSE" name="cfjyproductprocess.earlyWithdrawalClause" emptyText="---请选择---" nullItemText="---请选择---" showNullItem="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input id="startInterestDate" class="nui-datepicker" name="cfjyproductprocess.startInterestDate" required="true" value=""/>
                    </td>
                    <td class="form_label">
                        到期日:
                    </td>
                    <td colspan="1">
                        <input id="dueDate" class="nui-datepicker" name="cfjyproductprocess.dueDate" required="true" value=""/>
                    </td>
                </tr>
                <tr>
                	<td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="cfjyproductprocess.tradingRate" required="true"/>
                    </td>
                    <td class="form_label">
                        存款期限:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" name="cfjyproductprocess.depositTerm" required="false"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="3">
                        <input class="nui-textbox" name="cfjyproductprocess.tradingOpponent" required="true" width="200px"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="3">
                        <input class="nui-textarea"name="cfjyproductprocess.remark" width="100%" height="100px"/>
                    </td>
                </tr>
            </table>
