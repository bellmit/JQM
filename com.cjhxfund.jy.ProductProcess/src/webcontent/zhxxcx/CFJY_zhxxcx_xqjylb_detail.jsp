			...
			<table id="table1" class="table" style="height:100%;table-layout:fixed;">
				<tr>
					...
					<td colspan="1" width="20%">
						<input id="vcTxdt_XQJYLB" class="nui-datepicker" name="paramObject/vcTxdt" />
					</td>
					<td class="form_label" width="15%" align="right">
							结算日期:
					</td>
					<td colspan="1" width="20%">
						<input id="vcTradests_XQJYLB" class="nui-datepicker"  name="paramObject/vcTradests" />
					</td>
					<td class="form_label" width="10%" align="right">
							交易状态:
					</td>
					<td colspan="1" width="20%">
						<input id="vcSttlmdt_XQJYLB" class="nui-textbox" name="paramObject/vcSttlmdt"/>
					</td>
					<td class="form_label" width="10%" align="right">
							证券简称:
					</td>
					<td colspan="1" width="20%">
						<input id="vcStocknm_XQJYLB" class="nui-textbox"  name="paramObject/vcStocknm" />
					</td>
				...
				<tr>
					...
					<td colspan="1" width="20%">
						<input id="vcBuyernm_XQJYLB" class="nui-textbox" name="paramObject/vcBuyernm"/>
					</td>
					<td   class="form_label" width="30%" align="right">
							卖方持有人简称:
					</td>
					<td colspan="1" width="20%">
						<input id="vcSellernm_XQJYLB" class="nui-textbox"  name="paramObject/vcSellernm"/>
					</td>
					<td class="form_label" width="10%" align="right">
							买方状态:
					</td>
					<td colspan="1" width="20%">
						<input id="vcBuyersts_XQJYLB" class="nui-textbox"  name="paramObject/vcBuyersts" />
					</td>
					<td   class="form_label" width="30%" align="right">
							卖方状态:
					</td>
					<td colspan="1" width="20%">
						<input id="vcSellersts_XQJYLB" class="nui-textbox" name="paramObject/vcSellersts"/>
					</td>
				</tr>
			</table>
		</form>
