...
<div style="margin:0px 2px 0px 2px;width:100%;height:100%;" >
		   ...
		   <div class="search-condition">
			   <div class="list">
				 <form id="form_ZDHTCB" method="post">
				 	...
				 	<%-- 查询类型 --%>
				 	<input class="nui-hidden" name="paramObject/queryType" value="ZDHTCBNew">
				 	<%-- 筛选查询类型 --%>
	                ...
	                <table id="table1" class="table" style="height:100%;table-layout:fixed;">
	                	<tr>
	                        <td>
	                            ...
	                            <input class='nui-button' plain='false' text="产品筛选" iconCls="icon-search" onclick="searchByPROD_ZDHTCB()"/>
								...
								<input class='nui-button' plain='false' id="export_ZDHTCB_new" text="导出" iconCls="icon-download" onclick="export_ZDHTCB_new()"/>
	                        </td>
	                        <td style="width:135px;" align="right">
	                        	<span class="warn_red_bold">数据每 3 分钟自动刷新</span>
	                        </td>
	                    </tr>
					</table>
				</form>
           ...
           <div class="nui-fit">
			 ...
			 手工调整备注
                        ...
                        <div field="AM1_COL" headerAlign="center" align="right" width="130px">
			 			AM1机器猫当日下单的追加
                        </div>
                        <div field="AM2_COL" headerAlign="center" align="right" width="130px">
			 			AM2通过机器猫下单在O32控头寸的提取
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
	...
	//产品筛选
	function searchByPROD_ZDHTCB(){
		nui.get("exclusivelyShowSection").setValue("4");
		search(grid_ZDHTCB, "#form_ZDHTCB");
	}
	...
	grid_ZDHTCB.on("rowdblclick", function (e) {
		rowdblclickFun("CFJY_zhxxcx_zdhtcb_detail_new.jsp", "自动化头寸表明细(新)", 710, 400, e, grid_ZDHTCB);
	});
	//合并单元格
	...
	function save_ZDHTCB(){
		...
		saveData(grid_ZDHTCB, "com.cjhxfund.jy.ProductProcess.ZhxxcxUtilBiz.updateZDHTCBNew.biz.ext", "#form_ZDHTCB");
	}
	//导出
	function export_ZDHTCB_new(){
	    exportSubmit("export_ZDHTCB_new", "form_ZDHTCB", "划款指令轧差表（备用）");
	}
	<%-- 自动化头寸表结束!!! --%>
</script>
</body>
