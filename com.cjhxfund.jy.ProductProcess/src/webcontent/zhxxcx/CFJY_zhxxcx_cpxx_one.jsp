...
<body>
	<div class="nui-toolbar" style="text-align:center;line-height:30px;" borderStyle="border:0;">
		<div id="form" class="nui-form" style="padding:2px;" align="center" style="height:10%">
		  <!-- 查询用户类型，若是投顾，则过滤产品权限 -->
	 	  ...
	 	  <!-- 查询汇总母基金 -->
	 	  <input class="nui-hidden" name="paramObject/prodType" value="<%=request.getParameter("prodType")%>">
	 	  <!-- 查询类型 -->
	 	  <input class="nui-hidden" name="paramObject/queryType" value="CPXX">
          <label >代码/名称：</label>
	...
	<script type="text/javascript">
	    ...
	    function onOk() {
	    	if(grid.getSelecteds().length>12){
	    		nui.alert("产品选择超过12个，浏览体验将受影响！","系统提示",function(a){
		    		if(a=='ok'){
		        		CloseWindow("ok");
		    		}
	    		});
