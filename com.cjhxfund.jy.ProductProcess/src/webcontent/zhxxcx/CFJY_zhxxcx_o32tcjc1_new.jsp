...
<div style="margin:0px 2px 0px 2px;width:100%;height:100%;" >
	<div class="nui-tabs" id="tab" activeIndex="0" onactivechanged="activechangedFun" style="width:100%;height:100%;">
		...
		<div  title="分组管理" url="<%=request.getContextPath() %>/ProductProcess/zhxxcx/o32tcjc1_new/group_tree.jsp"></div>
              
        <div  title="标签管理" url="<%=request.getContextPath() %>/ProductProcess/zhxxcx/o32tcjc1_new/label_tree.jsp"></div>
