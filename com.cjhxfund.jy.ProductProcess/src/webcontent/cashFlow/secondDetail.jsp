		   ...
		   <div class="search-condition">
			   <div class="list">
				 <form id="form_second_detail" method="post">
				 	...
				 	<%-- 查询类型 --%>
				 	<input class="nui-hidden" id="queryType" name="paramObject/queryType" value="SECOND_DETAIL_XJL">
				 	<%-- 单元编号(必传) --%>
           ...
           <div class="nui-fit">
           		<div  id="datagrid_second_detail"
                	...
                	<div property="columns">
	                    ...
	                    <div field="businClass" headerAlign="center"  align="left" width="120px">
                                    	交易平台
	                    </div>
	                    ...
	                    <div field="businTypeName" headerAlign="center"  align="left" width="120px" visible="false">
                                    	业务类型
	                    </div>
    ...
    //页面X的删除功能
		...
		function search_second_detail(){
			...
			if(colField=="applyFundBal"||colField=="redeemFundBal"){
				...
				nui.get("vcMarket").setValue("6");//场外
			}else if(colField=="distributeBuyBal"){
				nui.get("type").setValue("1");//分销
			}
		...
		grid_second_detail.on("drawcell", function (e) {
			...
			var record = e.record;
			if(field == "occurBal"){
					sum = add(sum,record.occurBal);
			}
			var s = "<div style='color:Brown;'>";
	        	s+="发生总金额: "+formatNumber(sum,2,1) +"</div>";
