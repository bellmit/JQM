		   ...
		   <div class="search-condition">
			   <div class="list">
				 <form id="form_second_detail" method="post">
				 	...
				 	<%-- 查询类型 --%>
				 	<input class="nui-hidden" id="queryType" name="paramObject/queryType" value="EIGHTH_DETAIL_XJL">
				 	<%-- 单元编号(必传) --%>
           ...
           <div class="nui-fit">
           		<div  id="datagrid_second_detail"
                	...
                	<div property="columns">
	                    ...
	                    <div field="marketNo" headerAlign="center"  align="left" width="90px">
                                    	交易场所
	                    </div>
...
<script type="text/javascript">
    ...
    //页面X的删除功能
		...
		function search_second_detail(){
			...
			if( colField=="rzhgPactBal"|| colField=="rzhgExpireBalPact"|| colField=="rqhgBalPact"|| colField=="rqhgExpireBalPact"){
