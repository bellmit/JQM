			...
			<table id="instrcutInfo" class="instructTable" border="0" style="width: 100%;">
				<tr>
					...
					<td style="width: 35%;" align="left">
						...
						<input id="autoCalc" name="autoCalc"  onvaluechanged="autoCalcChecked"  class="nui-checkbox" checked="true" text="联动"/>
						</td>
				...
				<tr>
					...
					<td>
	            		...
	            		<a class="mini-button" plain="true" style="float:left;height:19px;" iconCls="icon-search" onclick="showHoldingPage('szIntegratedProtHolding.jsp')" tooltip="添加新债券"></a>
	            	</td>
				...
				<tr>
					...
					<td><input class="nui-textbox" style="width: 125px;" id="enFaceAmount" name="enFaceAmount"  required="true"  
						onvalidation="enFaceAmountCheck"  onblur="calculateNetPrice" /><span style="margin-left:3px;">万元</span></td>
				...
				<tr>
					...
					<td>
						<input id="vcRivalSeat" class="nui-textbox"  vtype="maxLength:64" style="width: 125px" name="vcRivalSeat" required="true" onvalidation="digitCheck"/>
					</td>
        		...
        		success:function(resp){
					...
					if(returnJson.exception == null){//客户下达指令/建议时间>产品参数配置时间
						 if(returnJson.rtnCode == "<%=com.cjhxfund.commonUtil.Constants.ATS_ORDER_OVER_DEAL_TIME%>"){ 
							window.parent.parentConfirm("该投资指令/建议下达时间过晚，无法完全保证交易达成，确定继续？", "提示",
					            function (action) {
        ...
        /**风控管理结束**/
		  ...
		  //收益率（%）
		   ...
		   //封装指令/建议参数
			...
			parameter["enFullPrice"] = enFullPrice;				//净价
			//行权收益率校验
...
function enFaceAmountCheck(e){
	...
	<script type="text/javascript" src="<%= request.getContextPath() %>/transaction/investNew/js/szBlockTrade.js"></script>
