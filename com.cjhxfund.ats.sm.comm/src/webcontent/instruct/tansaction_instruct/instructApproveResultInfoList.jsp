...
<body>
	...
	<script type="text/javascript">
	    ...
	    function resultNoValue(e){
			var s = null;
			if(e.row.resultNo != ""){
				s = "<a class='nui-button' style='color:#6959CD; cursor:pointer;text-decoration:underline;' onclick='instructDetail(\""+e.row.resultNo+"\")'>"+e.row.resultNo+"</a>";
			}
			return s;
		}
		...
		//展示指令详细信息
	   function instructDetail(resultNo) {
		    if (resultNo) {
		    	nui.open({
