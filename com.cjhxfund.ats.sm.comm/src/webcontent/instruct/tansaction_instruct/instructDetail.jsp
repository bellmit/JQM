		...
		<table id="table" border="0" cellpadding="2" cellspacing="0" style="width:100%;table-layout:fixed;">
			<tr>
                ...
                <td style="width:15%" align="left" id="">
                	<span id="orgRat1"><input name="instructDetail.vcOrgRating" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="issuerRating" readonly="true" enabled="false" width="80%"/></span>
                	<span id="orgRat2" style="display:none"><input name="instructDetail.vcOrgRating2" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="CF_JY_PRODUCT_PROCESS_SUBJECT_RATING" readonly="true" enabled="false" width="80%"/></span>
        	...
        	<tr>
                ...
                <td align="left">
                	<span id="bondRat1"><input name="instructDetail.vcBondRating" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="creditRating" readonly="true" enabled="false" width="80%"/></span>
                	<span id="bondRat2" style="display:none"><input name="instructDetail.vcBondRating2" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="CF_JY_PRODUCT_PROCESS_BOND_RATING" readonly="true" enabled="false" width="80%"/></span>
                </td>
    	...
    	function detail(selectRow){
    		...
    		if(lResultId != row.lResultId){
    			if(row["vcInstructSource"] == "3" ){
    				$("#orgRat1").css("display","block");
    				$("#orgRat2").css("display","none");
    				$("#bondRat1").css("display","block");
    				$("#bondRat2").css("display","none");
    			}else{
    				$("#orgRat1").css("display","none");
    				$("#orgRat2").css("display","block");
    				$("#bondRat1").css("display","none");
    				$("#bondRat2").css("display","block");
    				row["vcOrgRating2"] = row.vcOrgRating;
    				row["vcBondRating2"] = row.vcBondRating;
    			}
    			//组装指令/建议下达时间显示信息
