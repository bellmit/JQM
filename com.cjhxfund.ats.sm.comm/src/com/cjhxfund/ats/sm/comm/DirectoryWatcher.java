...
public class DirectoryWatcher extends AbstractResourceWatcher {
     ...
     * lastMod)
     */
    private Map currentFiles = new  ConcurrentHashMap();
     ...
     * Long lastMod)
     */
    private Map prevFiles = new  ConcurrentHashMap();
    ...
    public static void main(String[] args) {
        // Monitor e:/cyc every 5 seconds
        /*DirectoryWatcher dw = new DirectoryWatcher("D:/JEE/sz-588/workspace", 5);
