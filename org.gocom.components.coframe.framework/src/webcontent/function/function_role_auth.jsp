...
<div id="panel1" class="nui-panel" style="width:100%;height:100%;" showHeader="false"
    ...
    <div property="toolbar" style="padding:10px;">
    	<table style="width:100%;">
                <tr>
                <td style="width:100%;">
                	<a class='nui-button' plain='false' iconCls="icon-save" onclick="saveTree" title="保存"></a>
                	<span class="separator"></span>
			        <a class='nui-button' plain='false' iconCls="icon-expand" onclick="expandAll()" title="全部展开"></a>
					<a class='nui-button' plain='false' iconCls="icon-collapse" onclick="collapseAll()" title="全部折叠"></a>
                </td>
                <td style="white-space:nowrap;">
                	<input id="key" class="nui-textbox" style="width:100px;" onenter="onKeyEnter" emptyText="请输入查询条件" />
					<a class='nui-button' plain='false' style="width:60px;" iconCls="icon-search" onclick="search()">查询</a>
                </td>
            </tr>
        </table> 
    </div>
