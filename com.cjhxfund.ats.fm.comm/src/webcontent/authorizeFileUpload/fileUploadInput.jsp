...
String lProcessInstId = request.getParameter("lProcessInstId"); 
 ...
 <div style="width:100%;height:100%; "  id="dataform1" borderStyle="border:solid 1px #aaa;">
	...
	<div class="description" style="margin-top:10px; overflow: auto; ">
		 <table style="background-color:#f0f0f0; width:100%;" border="0px"  >
			 <tr><td colspan="5">&nbsp;&nbsp;文件名称格式：</td></tr>
			 <tr id="apply" style="display:none"><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正式指令文件名称必须包含“正式申购”字符</td></tr>
			 <tr id="pay" style="display:none"><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正式指令文件名称必须包含“正式缴款”字符</td></tr>
		 </table>
	 </div>
	...
	<script type="text/javascript">
		...
		UpSuccessBizParm[2]=<%=workItemId %>;
		UpSuccessBizParm[3]=<%=lProcessInstId %>;
		var typeHid=<%=type %>;
		...
		var UpSuccessBiz="com.cjhxfund.ats.fm.comm.common.updateApplyAuthStatus";//上传回调逻辑流全名称 逻辑流名称+逻辑构建全称，不可和回调函数名同时为空
	    ...
	    function startUpload(fileupload) {
	        ...
	        if((excelName.indexOf("正式缴款")>=0 && typeHid=="2") || (excelName.indexOf("正式申购")>=0 && typeHid=="1")){
	        	form.loading();//加载遮罩
		        if(excelName == ""){
			    	form.unmask();
	            ...
	            if(typeHid=="2"){
	               nui.alert("上传的文件名必须包含“正式缴款”字符","提示");
	            }else{
	               nui.alert("上传的文件名必须包含“正式申购”字符","提示");
	            }
	        	return false;
	        }
	    }
