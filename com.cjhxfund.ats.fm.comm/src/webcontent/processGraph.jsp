    ...
    <div title="审批意见">
      <!-- 流程处理信息列表 -->
		   <div id="grid_form">
			...
			<div id="deptGrid" class="nui-datagrid" style="width:100%;height:600px;"
			 ...
			 <div property="columns">            
			     ...
			     <div field="dCreateTime"  headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss">审批时间</div>                                        
		...
		<div id="detailGrid_Form" style="display:none;width: 100%;float: right;">
	        ...
	        <div id="employee_grid" class="mini-datagrid" style="width:100%;" 
	            url="com.cjhxfund.ats.fm.comm.attachUitlFunction.queryProcrssAttachment.biz.ext" idField="id"
  ...
  <script type="text/javascript">
    ...
    function onShowRowDetail(e) {
        ...
        nui.get("workitemid2").setValue(row.lWorkItemId);
      	...
      	employee_form = new nui.Form("#employee_form").getData(false,false);
      	
        var td = grid.getRowDetailCellEl(row);
        employee_grid.load(employee_form);
    ...
    function fileDownload(){
    	...
    	nui.confirm("确认要下载吗？","系统提示",function(action){
         ...
         function showMessage(e){
         	var activityInstId= $(e).attr("activityInstId");//活动实例iD
         	var activityDefID=$(e).attr("activityDefID");//活动定义id
         	var json = nui.encode({activityInstId:activityInstId});
       		$.ajax({
		            ...
		            success:function(text){
						...
						nui.open({
							url: "<%=request.getContextPath() %>/fm/comm/atsApproveInfoList.jsp?processinstid=<%=processinstid %>&activityDefID="+activityDefID,
