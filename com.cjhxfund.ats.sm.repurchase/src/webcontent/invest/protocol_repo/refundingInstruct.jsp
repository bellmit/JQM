...
<div id="thgregisterGrid" dataField="repuachaseList"
     url="com.cjhxfund.ats.sm.repurchase.RepurchaseBizManager.queryRefundInstruct.biz.ext"
...
//         }
    ...
    function opera(e) {
        if (e.row.disableOpra) {
            ...
            return '<a style="color:#00CCFF" href="javascript:showMaturedSequel()" >换券</a>';
        }

    }
    var showMaturedSequel = function () {
        mini.open({
            url: nui.context + "/repurchase/invest/protocol_repo/refundingDeclare.jsp",
            title: "协议式回购换券指令/建议",
            width: "556px",
            height: "505px",
            onload: function () {
    ...
    var thgmortagageGrid = mini.get("thgmortagageGrid");
