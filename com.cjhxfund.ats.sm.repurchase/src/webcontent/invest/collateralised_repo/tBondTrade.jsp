                    ...
                    <div>
                       ...
                       <div class="infoLabel"><label> 到期结算金额(元):</label>
                            <input class="nui-spinner" id="enSettleAmount" vtype="float" name="enSettleAmount"
                                    enabled="false"
                                    minValue="0" maxValue="100000000000000000000" format="n4"/>
                        </div>
                        ...
                        <div class="infoLabel"><label> 回购利息(元):</label>
                            <input class="nui-spinner" enabled="false" id="enRepoInterest" name="enRepoInterest"
                                   vtype="int"  minValue="0" maxValue="100000000000000000000" format="n4"/>
                        </div>
...
<script type="text/javascript" src="<%=contextPath%>/repurchase/invest/collateralised_repo/js/tBondTrade.js"></script>
