...
<%@include file="/repurchase/investNew/CFJYProductProcessEdit_common.jsp" %>
<%--
- Author(s): huangmizhi
        ...
        <div id="dataform1" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                ...
                <tr>
                    ...
                    <td id="saveInstructProcessType" colspan="1" width="27%" style="">
                    ...
                    <td id="editInstructProcessType" colspan="1" width="27%" style="display:none">
                        <input id="processType" class="nui-dictcombobox" dictTypeId="CF_JY_PRODUCT_PROCESS_PROCESS_TYPE_ZNHG" name="zhfwptjyznhg.processType" emptyText="---请选择---" nullItemText="---请选择---" showNullItem="true" required="true" onvaluechanged="changedProcessType(e)"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label" align="right" width="23%">
        ...
        <script type="text/javascript">
            ...
            function saveData(type){//type==0:风控试算   type==1:保存
                ...
                for(var i=0;i<gridData.length;i++){
                	bondCodeStr += "'"+gridData[i].bondCode+gridData[i].bondName+"'";
                ...
                if(type=="0"){
                	...
                	saveDataCommon(form, pageType, urlStr, roleType, processStatusUrl, validStatusUrl, updateInstructStatus);
                }
			}
                    ...
                    function setFormData(data){
                        ...
                        if (infos.pageType == "edit") {
		                    ...
		                    document.getElementById("editInstructProcessType").style.display = "";
		                    document.getElementById("saveInstructProcessType").style.display = "none";
                            ...
                            var isValid = json.zhfwptjyznhg.validStatus;
                            if(isValid != "0"){
                            	updateInstructStatus = "1";
                            	json.zhfwptjyznhg.processId = "";
                            }
