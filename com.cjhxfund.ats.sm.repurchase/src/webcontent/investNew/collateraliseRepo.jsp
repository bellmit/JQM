...
<div style="margin-bottom: 5px;">
        <div class="inputContainer" id="fullDirection">
            <ul>
                ...
                <li liType='input'><label><span>*</span>对方交易员:</label>
                    <div>
                       <input class="nui-textbox" id="vcCounterpartyTrader" onblur="ChangeTraderName(this)" name="vcCounterpartyTrader" style="width: 100%;" required="true"/>
                    </div>
                </li>
    ...
    <div style="text-align: center;padding-top: 10px;">
		...
		<div style="text-align: center;float:left;width:95%;position: fixed;padding-right: 20px;">
    		...
    		<a class="nui-button" iconCls="icon-ok" plain="true" onclick="sendDirective(1)">提交</a>
    		<a class="nui-button" iconCls="icon-goto" plain="true" onclick="sendDirective()">提交继续</a>
...
<script type="text/javascript">
    ...
    function showHolding() {
        nui.open({
            url: "<%=request.getContextPath() %>/repurchase/investNew/holding/collateraliseHolding.jsp",
            title: "银行间债券持仓",
            width: 850,
            height: 520,
            allowResize: true,
...
<script type="text/javascript" src="<%=request.getContextPath()%>/repurchase/investNew/js/repurchaseComm.js"></script>
<script type="text/javascript" src="<%= request.getContextPath() %>/riskMgr/js/riskMgrComm.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/repurchase/investNew/js/collateraliseRepo.js"></script>
