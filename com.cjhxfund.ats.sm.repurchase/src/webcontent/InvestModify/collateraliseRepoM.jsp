        ...
        <div class="inputContainer" id="fullDirection">
            <ul>
                ...
                <li liType='input'><label>到期结算金额(元):</label>
                    <div>
                        <input class="nui-spinner" id="enSettleAmount" vtype="float" name="enSettleAmount"
                               enabled="false" minValue="0" maxValue="999999999999" format="n2"
                               style="width: 100%;"/></div>
                </li>
                ...
                <li liType='input'><label>备注:</label>
                    <div><input class="nui-textbox" showClose="true" id="vcRemark" name="vcRemark"  onvalidation="remarkVali" style="width: 100%;"/></div>
                </li>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/repurchase/InvestModify/js/collateraliseRepoM.js"></script>
</body>
</html>