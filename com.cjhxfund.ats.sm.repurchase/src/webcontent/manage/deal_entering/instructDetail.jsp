	...
	<div id="dataform_instruct_detail">
		<table id="table" style="width:100%; table-layout:fixed;margin: 0xp;padding: 0px;" border="0" class="nui-form-table">	
			<tr>
                ...
                <td style="width:120px; padding: 5px 5px 5px 0px;" align="right">业务类别：</td>
                <td style="width:10%;">
                	<input name="instructDetail.vcBizType" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="bizTypeRepurchase" readonly="true" enabled="false"/>
                </td>
                <td style="width:115px; padding: 5px 5px 5px 5px;" align="right">委托方向：</td>
                <td style="width:10%;">
                	<input name="instructDetail.vcEntrustDirection" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="entrustDirectionRepurchase" readonly="true" enabled="false"/>
                </td>
        	</tr>
        	<tr>
        		<td style="padding: 5px 5px 5px 5px;" align="right" id="enFaceAmountText">回购金额（万元）: </td>
				<td style="" id="enFaceAmountValue">
					<input name="instructDetail.enFaceAmount" id="enFaceAmount" value="instructDetail.enFaceAmount" class="nui-spinner" minValue="0" maxValue="100000000000000" format="n4" readonly="true" enabled="false" />
				</td>
				<td style="display:none" id="enFullPriceAmountValue">
					<input name="instructDetail.enFullPriceAmount" id="enFullPriceAmount" value="instructDetail.enFullPriceAmount" class="nui-spinner" minValue="0" maxValue="100000000000000" format="n2" readonly="true" enabled="false" />
				</td>
                ...
                <td style="padding: 5px 5px 5px 5px" align="right">回购天数：</td>
                <td>
                	<input name="instructDetail.lRepoDays" class="nui-textbox" readonly="true" enabled="false"/>
                </td>
        	...
        	<tr>
                ...
                <td style="padding: 5px 5px 5px 5px" align="right">首次结算日：</td>
                <td>
                ...
                <td>
                	<input name="instructDetail.lMaturitySettleDate" class="nui-textbox" readonly="true" enabled="false"/>
                </td>
                <td style="padding: 5px 5px 5px 5px" align="right">占款天数：</td>
                <td>
                	<input name="instructDetail.lContractPeriods" class="nui-textbox" readonly="true" enabled="false"/>
                </td>
        	</tr>
        	<tr>
                <td style="padding: 5px 5px 5px 5px" align="right">报价方式：</td>
                <td>
                	<input name="instructDetail.vcQuoteMode" class="nui-dictcombobox" valueField="dictID" textField="dictName" dictTypeId="quoteMode" readonly="true" enabled="false"/>
                </td>
                <td style="padding: 5px 5px 5px 5px" align="right">回购利率（%）：</td>
                <td>
                	<input name="instructDetail.enRepoRate" class="nui-textbox" readonly="true" enabled="false"/>
                </td>
        	...
        	<tr>
                ...
                <td>
                	<input name="instructDetail.fsUpdate" class="nui-textbox tooltip" readonly="true" id="fsUpdate" enabled="false"/>
                </td>
        	</tr>
        	<tr>
        	 	<td style="padding: 5px 5px 5px 5px" align="right">备注：</td>
                <td colspan="3">
                	<input name="instructDetail.vcRemark" class="nui-textarea"style="width:98%" readonly="true" enabled="false"/>
                </td>
        	</tr>
<!--        	<tr>
        	 	<td style="padding: 5px 5px 5px 5px" align="right">附件：</td>
                <td colspan="3">
                	<input name="" class="nui-textbox" style="width:100%" readonly="true" />
                </td>
        	</tr>-->
		</table>
 	</div>	
	<script type="text/javascript">
    	...
    	function detail(row){
    		if(lInquiryId != row.lInquiryId){
    			...
    			var enFaceAmountText = $("#enFaceAmountText");
    			var enFaceAmountValue = $("#enFaceAmountValue");
    			var enFullPriceAmountValue = $("#enFullPriceAmountValue");
				if(row.vcBizType == "6"){
					enFaceAmountText.html("首期结算金额（元）：");
					enFullPriceAmountValue.show();
					enFaceAmountValue.hide();
				}else{
					enFaceAmountText.html("回购金额（万元）：");
					enFullPriceAmountValue.hide();
					enFaceAmountValue.show();
				}
    		}
    	}
