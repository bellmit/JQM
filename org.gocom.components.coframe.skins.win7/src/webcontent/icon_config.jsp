	...
	<tr>
		...
		>
		    ...
		    <div property="toolbar" style="padding-left:5px;">
		        <input type='button' class='nui-button' plain='false' text='全选' onclick="selectAll()" plain="false"/>
		        <input type='button' class='nui-button' plain='false' text='清空' onclick="clearAll()" plain="false"/>
		        <input type='button' class='nui-button' plain='false' text='生成图标' plain="false" onclick="importIcon()" iconCls="icon-downgrade"/>
		    </div>
					...
					<div class="mini-toolbar"
						...
						<table style="width:100%;">
							<tr>
								<td style="width:100%;">
									<a class="mini-button"
										iconCls="icon-remove" onclick="removeRow()" plain="false">
										删除
									</a>
									<span class="separator"></span>
									<a class="mini-button"
										iconCls="icon-save" onclick="saveData()" plain="false">
										保存
									</a>
								</td>
							</tr>
