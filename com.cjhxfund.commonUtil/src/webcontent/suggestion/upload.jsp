...
<%
	...
	DiskFileItemFactory factory = new DiskFileItemFactory();
		...
		base = ProductUtil.UPLOAD_FILE_PATH_LIUYANBAN;
		...
		//逻辑构建名称
			String componentName = "com.cjhxfund.commonUtil.attachUitlFunction";
			//逻辑流名称
		...
		try {
			...
			for (int i = 0 ;i < items.size(); i++){
				...
				if (!item.isFormField() && attachName.length() > 0) {
			    	...
			    	fileName = base + File.separator + attachName.substring(0,k) +'.'+extention;
			    	} 
