      ...
      <tr>
         ...
         <td style="width:20%;">
            <table style="width:100%;">
		    	<tr>
		    	  <td align="center">
		    	    <input type="button" id="addBtn" style="width:65px;text-align:center;" class='nui-button' plain='false' onclick="addOrgResource" text="添加" />
		    	  </td>
		    	</tr><%-- 添加 --%>
				<tr>
				  <td align="center">&nbsp;</td>
				...
				<tr>
				  <td align="center">
				    <input type="button" id="deleteBtn" class='nui-button' plain='false' style="width:65px;text-align:center;" text="删除" onclick="deleteOrgResource" />
				  </td>
				</tr><%-- 删除 --%>
			</table>
         </td>
