		...
		<div id="form1">
			...
			<table style="width:100%;table-layout:fixed;" class="nui-form-table" >
				<tr>
					...
					<td><input id="empcode" class="nui-textbox" name="employee.empcode" required="true" vtype="maxLength:30" onblur="setEmpCode"/></td>
				</tr>
				<tr class="odd">
		        ...
		        <div class="fieldset-body">
		            <table style="width:100%;table-layout:fixed;" class="nui-form-table" >
						<tr>
							...
							<td><input id="userId" class="nui-textbox" name="user.userId" required="true" vtype="maxLength:30" onblur="setUserId"/></td>
...
<div class="nui-toolbar" style="text-align:center;padding-top:5px;padding-bottom:5px;" 
    ...
    <a class='nui-button' plain='false'  style="width:60px;" iconCls="icon-save" onclick="add">保存</a>
    <span style="display:inline-block;width:25px;"></span>
    <a class='nui-button' plain='false' id="cancelBtn_01" iconCls="icon-cancel" style="width:60px;" onclick="cancel">取消</a>
</div>
...
<script type="text/javascript">
    ...
    function setEmpCode(){
    	var userId = nui.get("userId").getValue();   //获取登录用户名的值
    	var empcode = nui.get("empcode").getValue(); //获取员工代码
    	
    	//判断登录用户名为空时,将员工代码值设置进去
    	if(userId == ""){
    ...
    function setUserId(){
    	...
    	//判断员工代码为空时,将登录用户名值设置进去
    	if(empcode == ""){
    		nui.get("empcode").setValue(userId);
    	}
    }
    
    nui.get("password").setValue("A+123456");
</script>
