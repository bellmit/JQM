	...
	<div class="nui-fit" style="padding:10px;">
			...
			<div class="nui-toolbar" style="text-align:left;line-height:30px;padding:5px 0px 5px 10px;" borderStyle="border-bottom:0;">
				<table id="positionToolBar">
					<tr>
						...
						<td style="width:70px; text-align:right;"><input class='nui-button' plain='false' iconCls="icon-search" text="查询" onclick="searchPosition" /></td>
		...
		<div class="nui-fit">
			<div id="positionGrid" class="nui-datagrid" style="width:100%;height:100%;" onload="onGridLoad"
				...
				dataField="data" idField="positionid" allowResize="false" sizeList="[10,20,50,100,500]" pageSize="20" multiSelect="true" allowCellEdit="true">
			    <div property="columns">
			    	<div type="indexcolumn" width="30px"></div>
			        <div field="posicode" width="120" headerAlign="center" >岗位编号</div>
			        <div field="posiname" width="150" headerAlign="center" >岗位名称</div>
			        <div field="orgOrganization.orgname" width="150" headerAlign="center" >所属机构</div>
