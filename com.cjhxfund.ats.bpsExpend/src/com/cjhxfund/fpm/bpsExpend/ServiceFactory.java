...
public class ServiceFactory {
	 ...
	 * @throws WFServiceException 
	 */
	public static IWFActivityInstManager getActivityInstManager() throws WFServiceException {
		return BPSServiceClientFactory.getDefaultClient().getActivityInstManager();
	}
	 ...
	 * @throws WFServiceException 
	 */
	public static IWFRelativeDataManager getRelativeDataManager() throws WFServiceException {
		return BPSServiceClientFactory.getDefaultClient().getRelativeDataManager();
	}
}
