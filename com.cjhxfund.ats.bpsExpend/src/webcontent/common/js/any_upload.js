...
function addReadyFileInfo(fileid,fileName,message,status,size1){
	...
	col5.style.width="80";
	//新增上传文件
	var newRow = { lAttachId:fileid,sysid:fileid,vcAttachName:fileName,name:fileName,message:message,status:status,vcAttachSize:attachSize,attachSize:attachSize};
