...
<div style="padding-top:5px">
	<div id="webform">
		...
		<div class="nui-toolbar" style="text-align:center;padding-top:5px;padding-bottom:5px;" borderStyle="border:0;">
			<a class='nui-button' plain='false' style="width:60px;" iconCls="icon-save" onclick="doSave()">保存</a>
			<span style="display:inline-block;width:25px;"></span>
			<a class='nui-button' plain='false' style="width:60px;" iconCls="icon-cancel" onclick="doCancel()">取消</a>
		</div>
	</div>
</div>
</body>
