...
<table style="width:100%;table-layout:fixed;" border="0" class="nui-form-table">
	...
	<%-- <tr>
		...
		<td colspan="3" class="td2" style="border-bottom: 1px solid #D3D3D3;">
			<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_JYYSCMB,ATS_FM_CZ_SCFXXY,ATS_FM_CZ_JYYSCFXXY">
				<iframe id="prodIfm" width="100%" height="130px"  frameborder="no" border="0" marginwidth="0" marginheight="0" scolling="no"  src="<%= request.getContextPath() %>/fm/comm/fileupload/any_upload.jsp?bizId=<%=bizId %>&processinstid=<%=processinstid %>&workItemID=<%=workItemID %>&attachType=1&attachBusType=1&type=1" ></iframe>  
			</l:notIn>
			<l:in property="workitem/activityDefID" targetValue="ATS_FM_JYYSCMB,ATS_FM_CZ_SCFXXY,ATS_FM_CZ_JYYSCFXXY">
				<iframe id="prodIfm" width="100%" height="130px"  frameborder="no" border="0" marginwidth="0" marginheight="0" scolling="no"  src="<%= request.getContextPath() %>/fm/comm/fileupload/any_upload_AnnexSeal.jsp?bizId=<%=bizId %>&processinstid=<%=processinstid %>&workItemID=<%=workItemID %>&attachType=1&attachBusType=1&activityDefID=<b:write property="workitem/activityDefID" />" ></iframe>
			</l:in>
		</td>
	</tr> --%>
	<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_TGLR,ATS_FM_TGFH,ATS_FM_WTRFH">
	<tr>
		<td class="td1" style="border-bottom: 1px solid #D3D3D3;" align="right">主题:</td>
		<td colspan="1" class="td2" style="border-bottom: 1px solid #D3D3D3;">
			<input class="nui-textbox" width="80%" name="bpsParam.theme" id="theme" width="170px" value="<b:write property="firstGradeBond/vcProductName" />-<b:write property="firstGradeBond/vcStockName" />" readonly="readonly"/>
		</td>
		<td class="td1" style="border-bottom: 1px solid #D3D3D3;" align="right">接收人传真号:</td>
		<td colspan="1" class="td2" style="border-bottom: 1px solid #D3D3D3;">
		    <input class="nui-textbox" readonly="readonly" name="bpsParam.FaxNumber" id="FaxNumber" readonly="readonly" width="80%" value="<b:write property="firstGradeBond/vcFaxNumber" />"/>
		</td>
	</tr>
	<l:notIn property="workitem/activityDefID" targetValue="ATS_FM_TGLR,ATS_FM_TGFH,ATS_FM_WTRFH,ATS_FM_XXHD1,ATS_FM_XXHD2,ATS_FM_TZJLFH,ATS_FM_ZJZLSP,ATS_FM_FKRGSH,ATS_FM_TBYY">
	<tr>
		<td class="td1" style="border-bottom: 1px solid #D3D3D3;" align="right">接收人姓名:</td>
		<td colspan="1" class="td2" style="border-bottom: 1px solid #D3D3D3;">
			<input class="nui-textbox"  width="80%" name="bpsParam.recvName" id="recvName" width="170px" readonly="readonly"/>
		</td>
		<td class="td1" style="border-bottom: 1px solid #D3D3D3;" align="right">接收人公司名称:</td>
		<td colspan="1" class="td2" style="border-bottom: 1px solid #D3D3D3;">
			<input class="nui-textbox" name="bpsParam.recvCompany" id="recvCompany" width="170px"  readonly="readonly"/>
		</td>
	</tr>
	</l:notIn>
	<tr>
		...
		<td colspan="1" class="td2" style="border-bottom: 1px solid #D3D3D3;">
			<input class="nui-textbox" readonly="readonly" name="bpsParam.vcTelephoneNumber" id="vcTelephoneNumber" readonly="readonly" width="80%" value="<b:write property="firstGradeBond/vcTelephoneNumber" />"/>
		</td>
