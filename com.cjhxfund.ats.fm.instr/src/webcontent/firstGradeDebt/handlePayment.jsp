...
<!-- 	            <input class="nui-hidden" name="bizCriteria/_orderby[2]/_property" value="dPaymentDate" /> -->
                ...
                <table id="table1" border="0" cellpadding="1" cellspacing="1" style="width:100%;table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:20%" align="left">
                            <input class="nui-datepicker" id="dPaymentDate" format="yyyy-MM-dd" name="bizCriteria/_and[1]/_and[1]/_expr[1]/dPaymentDate" width="100%"/>
                            <input class="nui-hidden" name="bizCriteria/_and[1]/_and[1]/_expr[1]/_op" value=">=">
                        </td>
                        <td style="width:60px" align="center">至</td>
                        <td style="width:20%" align="left">
                            <input class="nui-datepicker" id="dPaymentDate2" format="yyyy-MM-dd" name="bizCriteria/_and[1]/_and[1]/_expr[2]/dPaymentDate" width="100%"/>
                            <input class="nui-hidden" name="bizCriteria/_and[1]/_and[1]/_expr[2]/_op" value="<=">
                        </td>
                            <td style="width:60px" align="right">
                            产品名称:
                        </td>
                      ...
                      <!--  <td style="width:80px" align="right">
                        ...
                        <td style="width:20%" align="left">
                        	<input class="nui-combobox" name="bizCriteria/_expr[6]/cTransferMoney" dictTypeId="TransferMoney"  id="TransferMoney"
                    ...
                    <tr>
                        ...
                        <td align="left">
                        	<input class="nui-combobox" name="bizCriteria/_expr[10]/currentState"  id="currentstate"
                        			data="[{id:2, text: '流程运行中'}, {id:'7,8', text: '流程已结束'} ]" value="2" 
                        			showNullItem="false" multiSelect="true" showClose="true" valueFromSelect="true"
									  oncloseclick="onCloseClickValueEmpty"  width="100%"/>
                        	<input class="nui-hidden" name="bizCriteria/_expr[10]/_op" value="in">
                        </td> 
                        <td align="right">授权状态: </td>
                        <td align="left">
                        	<input class="nui-dictcombobox" name="bizCriteria/_expr[15]/cPaymentAuthStatus" id="ApplyAuthStatus" oncloseclick="onCloseClickValueEmpty"
                        	multiSelect="true" data="[{id: 2, text: '正式授权缴款'}, {id: 3, text: '非正式授权缴款'} ]" width="100%" showClose="true" />
                        	<input class="nui-hidden" name="bizCriteria/_expr[15]/_op" value="in">
                        	
                        	<!-- <input class="nui-hidden" name="bizCriteria/_expr[14]/cApplyAuthStatus" id="cApplyAuthStatus"/>
                        	<input class="nui-hidden" name="bizCriteria/_expr[14]/_op" value="in">
                        	
                        	<input class="nui-hidden" name="bizCriteria/_expr[15]/cPaymentAuthStatus" id="cPaymentAuthStatus"/>
                        	<input class="nui-hidden" name="bizCriteria/_expr[15]/_op" value="in"> -->
                        </td> 
                        <td align="left" style="width:80px">
                        	...
                        	<input id="vcProcessType" class="nui-hidden" name="bizCriteria/_or[2]/_and[1]/_expr[1]/vcProcessType" value="1,5"  width="100%" />
                        	<input class="nui-hidden" name="bizCriteria/_or[2]/_and[1]/_expr[1]/_op" value="in">
					        
							<input class="nui-hidden" id="activitydefSortno" name="bizCriteria/_or[2]/_and[1]/_expr[2]/activitydefSortno" width="100%" value="14"/>
                        	<input class="nui-hidden" id="activitydefSortnoeOp" type="hidden" name="bizCriteria/_or[2]/_and[1]/_expr[2]/_op" value=">=">
                            
                            <input id="vcProcessType2" class="nui-hidden" name="bizCriteria/_or[2]/_expr[3]/vcProcessType" value="8"  width="100%" />
                        	<input class="nui-hidden" name="bizCriteria/_or[2/_expr[3]/_op" value="in">
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:100%;">                            
                            ...
                            <privilege:operation sourceId="ATS_JYGL_UPDATE" sid="updateHandleBid" clazz="nui-button" onClick="updateHandleBid()" lableName="修改划款情况" iconCls="icon-edit" ></privilege:operation>
                            <privilege:operation sourceId="ATS_JYGL_SCSGH" sid="generatePurchaseOrder" clazz="nui-button" onClick="generatePurchaseOrder()" lableName="生成申购函" iconCls="icon-add"></privilege:operation>
            ...
            <div class="nui-fit" >
                <div 
                        ...
                        url="com.cjhxfund.ats.fm.instr.firstGradePayment.payMentInvestAdviceManage.biz.ext"
                        pageSize="20"
                        showPageInfo="true"
                        multiSelect="true"
                    ...
                    <div property="columns">
						...
						<div field="lProcessInstId" headerAlign="center" allowSort="true" visible="false">
		 流程ID
                        </div>
                        <div field="applyauthstatus" headerAlign="center" allowSort="true" visible="false">
		 申购授权状态
                        </div>
		           ...
		           流程编号
                        ...
                        <div field="biztypename" headerAlign="center" allowSort="true" width="70px" renderer="rendererBizTypeName">
                            流程类别
                        </div>
                        <div field="enBallotPrice" headerAlign="center" allowSort="true" >
                           发行价格
                        </div>
                         <div field="enPayFaceValue" headerAlign="center" allowSort="true" >
                            缴款面值
                        </div>
                        <div field="enPaymentMoney" headerAlign="center" allowSort="true" >
                            缴款金额
                        </div>
                        <div field="t0jyky" headerAlign="center" allowSort="true" width="80px" align="right">
                           头寸可用情况
                        </div>
                        <div field="lFixValidStatus" headerAlign="center" align="center" allowSort="true"  renderer="renderlFixValidStatus">
              Fix发送状态
                        </div>
                        <div field="cTransferMoney" headerAlign="center"  allowSort="true" width="80px"  renderer="rendercTransferMoney">
                            划款情况
                        </div>
	   	 ...
	   	 市场代码
	                    ...
	                    <div field="vcStockCode" headerAlign="center" align="center" allowSort="true" visible="false">
	   	 债券代码
	                    </div>
	                    <div field="vcProductCode" headerAlign="center" align="center" allowSort="true" visible="false">
	   	 产品代码
	                    </div>
	...
	<script type="text/javascript">
		...
		//给业务日期查询条件赋值
		nui.get("dPaymentDate").setValue(new Date());
		//nui.get("dPaymentDate2").setValue(new Date());
			...
			success:function(text){
		        ...
		        if(text.participantId.indexOf(userId_zbqr) < 0){
		           ...
		           if(text.isInvestment==1 && text.isProduct>0){
			          ...
			          bool=false;
			        }else if(text.isInvestment==0 && text.isProduct==0){
   ...
   //word文档下载
	...
	function test(){
		$.ajax({
			url:"com.cjhxfund.ats.fm.instr.tempTest.testInsertDebtTemp.biz.ext",
			type:'POST',
			cache:false,
			async:false,
			contentType:'text/json',
