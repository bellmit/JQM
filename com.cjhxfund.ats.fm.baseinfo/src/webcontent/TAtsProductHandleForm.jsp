    ...
    <body>
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1" align="left" width="80%">
                        <input id="relaType" class="nui-dictcombobox" dictTypeId="CF_JY_COMB_PRODUCT_HANDLE_RELA_TYPE" name="TAtsProductHandle.vcRelateType" emptyText="---请选择---" nullItemText="---请选择---" popupHeight="130" popupMaxHeight="130" showNullItem="true" required="true" width="200px" onvaluechanged="relaTypeValueChangedFun"/>
                    </td>
                 </tr>
                 <tr>
                    <td class="form_label" align="right" width="20%">
                    ...
                    <td colspan="1" align="left" width="80%">
                        <input id="combProductCode" required="true" width="100%"class="nui-textboxlist"  name="TAtsProductHandle.vcProductCode" searchField="searchKey" dataField="productCombis"
                        	valueField="fundInfo" textField="fundInfo" url="com.cjhxfund.ats.fm.comm.common.getProductCombisByKey.biz.ext"  value="" text=""/>
                 ...
                 <tr>
                    ...
                    <td colspan="1" align="left" width="80%">
                        <input id="userIdList" width="100%" required="true" name="TAtsProductHandle.vcUserId" allowInput="false" showClose="true" oncloseclick="onCloseClick" class="nui-buttonEdit nui-form-input" onbuttonclick="selectUser" />
        ...
        <script type="text/javascript">
            ...
            function saveData(){
                ...
                //编辑
                if(pageType=="edit"){
                    urlStr = "com.cjhxfund.ats.basicInfo.TAtsProductHandleBiz.updateTAtsCombProductHandle.biz.ext";
                }
                form.validate();
                ...
                if(relaType!="A1" && relaType!="A2"){//若不是配置“投顾录入确认可为同一人员”、“是否需要委托人复核”，则关联用户必输
                	//重新设置用户ID、用户姓名
	                var userIdVal = "";
	                var userNameVal = "";
		    ...
		    function selectUser(e) {
		        var btnEdit = this;
		        nui.open({
		            url: "<%=request.getContextPath() %>/fm/baseinfo/select_employee.jsp",
		            showMaxButton: false,
		            title: "选择用户",
		            width: 500,
		            height: 580,
