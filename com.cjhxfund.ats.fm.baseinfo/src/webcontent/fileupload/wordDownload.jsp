...
<%@page import="com.cjhxfund.ats.fm.comm.JavaExportDoc"%>
...
<%
   ...
   File file = JavaExportDoc.wordDownload("发行人名称.xml",commonUtil.UPLOAD_FILE_PATH_LIUCHENG ,processBond,fileName);
