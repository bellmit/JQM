		...
		<div id="nui-form2-toolbar" class="nui-toolbar" style="text-align:left;line-height:25px;padding:5px 0px 5px 10px;" borderStyle="border-bottom:0;">
			<table id="employeeToolBar2" style="width:100%">
				<tr>
					...
					<td nowrap>规则名称：</td>
					<td><input id="ruleName" class="nui-textbox" name="ruleName" emptyText="请输入规则名称" onenter="onKeyEnter"/>  </td>
					...
					<td style="width:70px;"><input class='nui-button' plain='false' iconCls="icon-search" text="查询" onclick="searchTotal()" /></td>
        ...
        <table style="width:100%;">
            <tr>
                <td style="width:100%;">
                    ...
                    <a class='nui-button' plain='false' iconCls="icon-save" onclick="saving();" id="btn_save">批量授权</a>   
                </td>
