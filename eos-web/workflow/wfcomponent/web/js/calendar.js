...
AutoFormCalendar.prototype.draw = function() {
    ...
    mvAry[mvAry.length] = ' <input name="calendarToday" type="button" id="calendarToday" value="'mvAry[mvAry.length] = (calendar.DateMode == pickMode["day"]) ? AutoFormCalendar.language["today"][this.lang] : AutoFormCalendar.language["pickTxt"][this.lang];
    ...
    obj.onclick = function() {
        var today = (calendar.DateMode != pickMode["day"]) ? new Date(calendar.year, calendar.month, calendar.day, calendar.hour, calendar.minute, calendar.second) : new Date(); // 
