	...
	<script type="text/javascript">
    	...
    	//tab页权限处理
		 nui.ajax({
            ...
            type:'POST',
            data:{funcCode:"ATS_JSGL_COMMMODE,ATS_JSGL_PRODUCTAUTHOR,ATS_JSGL_BUSINESS_AUTHOR,ATS_JSGL_PRODUCTINFO"},
            cache:false,
            ...
            success:function(text){
	        	...
	        	if(result){	        	
	        		...
	        		for(var k=0;k<result.length;k++){
	        			if(result[k].RES_ID=="ATS_JSGL_COMMMODE"){
							tempArray[0]=result[k];
						}
	        			if(result[k].RES_ID=="ATS_JSGL_PRODUCTAUTHOR"){
							tempArray[1]=result[k];
						}
						if(result[k].RES_ID=="ATS_JSGL_BUSINESS_AUTHOR"){
							tempArray[2]=result[k];
						}
						if(result[k].RES_ID=="ATS_JSGL_PRODUCTINFO"){
