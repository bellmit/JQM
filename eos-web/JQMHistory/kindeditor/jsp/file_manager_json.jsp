...
//String rootPath = "/home/ats/FileUploadPath/JQM/LiuYanBan";
//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
//String rootUrl  = "/home/ats/FileUploadPath/JQM/LiuYanBan";
...
if(serverType.equalsIgnoreCase("0") && serverType != null){
	rootPath =  pageContext.getServletContext().getRealPath("/") + "attached/";
	rootUrl = request.getContextPath() + "/attached/";
}else{
	rootPath  = ProductUtil.UPLOAD_FILE_PATH_LIUYANBAN;
	rootUrl  = ProductUtil.UPLOAD_FILE_PATH_LIUYANBAN;
}
